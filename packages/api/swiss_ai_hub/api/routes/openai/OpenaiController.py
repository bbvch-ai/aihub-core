...
from swiss_ai_hub.api.routes.openai.dto.ChatCompletionRequest import ChatCompletionRequest
from swiss_ai_hub.api.routes.openai.dto.EmbeddingsRequest import EmbeddingsRequest
