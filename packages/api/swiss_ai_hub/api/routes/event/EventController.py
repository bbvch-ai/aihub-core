...
from swiss_ai_hub.core.persistence.messaging.entities.PersistedAgentEventEntity import TimeRange
...
from swiss_ai_hub.api.routes.event.dto.EventTimeseries import EventTimeseries
