...
from swiss_ai_hub.api.routes.agent.dto.AgentFileUploadRequest import AgentFileUploadRequest
from swiss_ai_hub.api.routes.agent.dto.AgentFileUploadResponse import AgentFileUploadResponse
from swiss_ai_hub.api.routes.agent.dto.AgentFileValidationRequest import AgentFileValidationRequest
from swiss_ai_hub.api.routes.agent.dto.AgentFileValidationResponse import AgentFileValidationResponse
...
from swiss_ai_hub.api.routes.agent.dto.UpdateAgentInstanceDTO import UpdateAgentInstanceDTO
from swiss_ai_hub.api.routes.thread.dto.PaginatedThreadsResponse import PaginatedThreadsResponse
...
class AgentController(Controller):
    ...
    def update_agent_instance(self, route: str = "/classes/{agent_class}/instances/{agent_id}") -> Self:
        ...
        async def update_agent_instance(
            ...
            from swiss_ai_hub.core.i18n.LocaleHandler import LocaleHandler as LH
