...
class AgentController(TenantScopedController):
    ...
    AGENT_INSTANCE_ROUTE = "/classes/{agent_class}/instances/{agent_id}"
    ...
    def get_agent_instance(self, route: str = AGENT_INSTANCE_ROUTE) -> Self:
        @self.router.get(route, tags=self.tags)
    ...
    def update_agent_instance(self, route: str = AGENT_INSTANCE_ROUTE) -> Self:
    ...
    def delete_agent_instance(self, route: str = AGENT_INSTANCE_ROUTE) -> Self:
