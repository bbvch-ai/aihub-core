...
class AgentController(TenantScopedController):
    ...
    @capability("api.access.capabilities.ops.agent.see")
    ...
    @capability("api.access.capabilities.ops.agent.see_class")
    ...
    @capability("api.access.capabilities.ops.agent.create")
    ...
    @capability("api.access.capabilities.ops.agent.use")
    ...
    @capability("api.access.capabilities.ops.agent.manage")
