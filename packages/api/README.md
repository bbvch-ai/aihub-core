---
title: Swiss AI Hub API
index: 4
---

# 🚀 Swiss AI Hub API Developer's Guide

[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_api-core&metric=alert_status&token=0813ff21e25c4e60e66e06acaefd2927ba63e897)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_api-core)

[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_api-core&metric=security_rating&token=0813ff21e25c4e60e66e06acaefd2927ba63e897)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_api-core)

[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_api-core&metric=vulnerabilities&token=0813ff21e25c4e60e66e06acaefd2927ba63e897)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_api-core)

[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_api-core&metric=sqale_rating&token=0813ff21e25c4e60e66e06acaefd2927ba63e897)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_api-core)

[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_api-core&metric=ncloc&token=0813ff21e25c4e60e66e06acaefd2927ba63e897)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_api-core)
...
### 📚 Introduction to `swiss_ai_hub.api`

You are contributing to the **swiss_ai_hub.api** scope, which contains the main user-facing REST API (FastAPI) and
WebSocket gateway within the Swiss AI Hub platform. This scope implements HTTP endpoints and real-time communication
that connect frontend applications to the underlying Swiss AI Hub services.

### 📁 Project Structure

The `swiss_ai_hub.api` scope is organized as follows:

```
swiss_ai_hub.api/
├── swiss_ai_hub.api/                 # Main package source
...
1. **Create Test Files**: Write comprehensive tests for your endpoints.
   ...
   from swiss_ai_hub.api.routes.my_domain.MyController import MyController
...
The Swiss AI Hub uses a sophisticated hierarchical permission system with wildcards and implicit checks. All permissions
