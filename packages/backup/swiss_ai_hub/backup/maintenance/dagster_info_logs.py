...
_LABEL = "dagster_info_logs"
_WHERE = "dagster_event_type IS NULL AND event::jsonb->>'level' = '20'"


class DagsterInfoLogsHandler(MaintenanceHandler):
    """Delete Python INFO (level=20) log entries from event_logs older than the configured retention."""
