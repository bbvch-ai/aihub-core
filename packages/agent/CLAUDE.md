...
- Shared mailbox step functions: `packages/agent/swiss_ai_hub/agent/imap/step_functions.py` (`do_list_unread`,
  `do_fetch_and_archive`, `do_file_message` — used by both mailbox blueprints)
