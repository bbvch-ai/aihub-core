 ...
 */
export const createTenant = <TComposable extends Composable = '$fetch', DefaultT extends CreateTenantResponse = CreateTenantResponse>(options: Options<TComposable, CreateTenantData, CreateTenantResponse, DefaultT>) => (options.client ?? client).post<TComposable, CreateTenantResponse | DefaultT, CreateTenantError, DefaultT>({
    responseTransformer: createTenantResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/admin/tenants/',
    ...options,
    headers: {
