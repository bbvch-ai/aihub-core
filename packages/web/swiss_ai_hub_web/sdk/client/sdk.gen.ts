 ...
 */
export const deleteDocument = <TComposable extends Composable = '$fetch', DefaultT extends DeleteDocumentResponse = DeleteDocumentResponse>(options: Options<TComposable, DeleteDocumentData, DeleteDocumentResponse, DefaultT>) => (options.client ?? client).delete<TComposable, DeleteDocumentResponse | DefaultT, DeleteDocumentError, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
...
/**
 * Send User Message Event To Mcp React Agent
 *
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventPost = <TComposable extends Composable = '$fetch', DefaultT extends SendUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventPostResponse = SendUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventPostResponse>(options: Options<TComposable, SendUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventPostData, SendUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventPostResponse, DefaultT>) => (options.client ?? client).post<TComposable, SendUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventPostResponse | DefaultT, SendUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventPostError, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
...
/**
 * Stream User Message Event To Mcp React Agent
 *
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventStreamPost = <TComposable extends Composable = '$fetch', DefaultT = undefined>(options: Options<TComposable, StreamUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventStreamPostData, unknown, DefaultT>) => (options.client ?? client).post<TComposable, unknown | DefaultT, StreamUserMessageEventToMcpReactAgentAgentsClassesMcpReactAgentInstancesAgentIdUserMessageEventStreamPostError, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
