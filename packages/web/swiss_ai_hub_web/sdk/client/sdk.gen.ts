 ...
 */
export const initiateFileUpload = <TComposable extends Composable = '$fetch', DefaultT extends InitiateFileUploadResponse = InitiateFileUploadResponse>(options: Options<TComposable, InitiateFileUploadData, InitiateFileUploadResponse, DefaultT>) => (options.client ?? client).post<TComposable, InitiateFileUploadResponse | DefaultT, InitiateFileUploadError, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 */
export const validateFileUpload = <TComposable extends Composable = '$fetch', DefaultT extends ValidateFileUploadResponse = ValidateFileUploadResponse>(options: Options<TComposable, ValidateFileUploadData, ValidateFileUploadResponse, DefaultT>) => (options.client ?? client).post<TComposable, ValidateFileUploadResponse | DefaultT, ValidateFileUploadError, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
 ...
 */
export const configureTenant = <TComposable extends Composable = '$fetch', DefaultT extends ConfigureTenantResponse = ConfigureTenantResponse>(options: Options<TComposable, ConfigureTenantData, ConfigureTenantResponse, DefaultT>) => (options.client ?? client).post<TComposable, ConfigureTenantResponse | DefaultT, ConfigureTenantError, DefaultT>({
    responseTransformer: configureTenantResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/admin/tenants/',
    ...options,
    headers: {
 ...
 */
export const updateTenant = <TComposable extends Composable = '$fetch', DefaultT extends UpdateTenantResponse = UpdateTenantResponse>(options: Options<TComposable, UpdateTenantData, UpdateTenantResponse, DefaultT>) => (options.client ?? client).patch<TComposable, UpdateTenantResponse | DefaultT, UpdateTenantError, DefaultT>({
    responseTransformer: updateTenantResponseTransformer,
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
    url: '/admin/tenants/{tenant_id}',
    ...options,
    headers: {
 ...
 */
export const getAnonymousFileUrl = <TComposable extends Composable = '$fetch', DefaultT = undefined>(options: Options<TComposable, GetAnonymousFileUrlData, unknown, DefaultT>) => (options.client ?? client).get<TComposable, unknown | DefaultT, GetAnonymousFileUrlError, DefaultT>({ url: '/{tenant_id}/files/anonymous/url/{container}/{file_path}', ...options });
 ...
 */
export const getAnonymousFileRedirect = <TComposable extends Composable = '$fetch', DefaultT = undefined>(options: Options<TComposable, GetAnonymousFileRedirectData, unknown, DefaultT>) => (options.client ?? client).get<TComposable, unknown | DefaultT, GetAnonymousFileRedirectError, DefaultT>({ url: '/{tenant_id}/files/anonymous/redirect/{container}/{file_path}', ...options });
...
/**
 * Send User Message Event To L L M Wrapping Agent
 *
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendUserMessageEventToLLMWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventPost = <TComposable extends Composable = '$fetch', DefaultT extends SendUserMessageEventToLlmWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventPostResponse = SendUserMessageEventToLlmWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventPostResponse>(options: Options<TComposable, SendUserMessageEventToLlmWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventPostData, SendUserMessageEventToLlmWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventPostResponse, DefaultT>) => (options.client ?? client).post<TComposable, SendUserMessageEventToLlmWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventPostResponse | DefaultT, SendUserMessageEventToLlmWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventPostError, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
...
/**
 * Stream User Message Event To L L M Wrapping Agent
 *
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamUserMessageEventToLLMWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventStreamPost = <TComposable extends Composable = '$fetch', DefaultT = undefined>(options: Options<TComposable, StreamUserMessageEventToLlmWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventStreamPostData, unknown, DefaultT>) => (options.client ?? client).post<TComposable, unknown | DefaultT, StreamUserMessageEventToLlmWrappingAgentTenantIdAgentsClassesLlmWrappingAgentInstancesAgentIdUserMessageEventStreamPostError, DefaultT>({
    security: [{ scheme: 'bearer', type: 'http' }, { scheme: 'bearer', type: 'http' }],
