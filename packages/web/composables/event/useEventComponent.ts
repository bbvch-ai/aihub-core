...
import {
  ...
  EventDisplayConversationTagsEvent,
  EventDisplayConversationTitleEvent,
  EventDisplaySuggestedFollowUpQuestionsEvent,
...
export const useEventComponent = () => {
  const resolveComponentForEvent = (event: ContextualizedAgentEvent) => {
    const mapping = {
      ...
      ConversationTagsEvent: EventDisplayConversationTagsEvent,
      SuggestedFollowUpQuestionsEvent: EventDisplaySuggestedFollowUpQuestionsEvent,
