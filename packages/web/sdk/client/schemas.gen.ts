...
export const AgentFileUploadResponseSchema = {
  ...
  type: "object",
  required: ["upload_url", "file_id", "expires_in"],
...
export const BucketNamespacePairSchema = {
  ...
  type: "object",
  required: ["bucket_name", "namespace_name"],
...
export const DatabaseDTOSchema = {
  ...
  type: "object",
  required: ["name", "display_name", "auto_sync", "deletable", "namespaces"],
  title: "DatabaseDTO",
} as const;
...
export const AgentInTheLoopRequestEventWritableSchema = {
  ...
  additionalProperties: true,
  type: "object",
  required: ["start_event", "other_agent_topic"],
  title: "AgentInTheLoopRequestEvent",
  description:
    "An event delegating a task to another agent at a specific point in a workflow.\n\n### Why AgentInTheLoopRequestEvent?\nIn automated workflows, certain tasks may require specialized capabilities from other agents. This event:\n- Is a `DisplayEvent`, so the delegation can be monitored in user interfaces\n- Carries a start event that initiates the other agent's task\n- Manages context sharing between agents (thread, display, run IDs)\n- Handles both successful responses and exceptions from the delegated agent",
} as const;
...
export const ChipsInputWritableSchema = {
  properties: {
    is_formkit_element: {
      type: "boolean",
      const: true,
...
export const HumanInTheLoopRequestEventWritableSchema = {
  ...
  additionalProperties: true,
  type: "object",
  required: ["question", "topic", "hitl_type"],
  title: "HumanInTheLoopRequestEvent",
  description:
    "Base event asking a human for input, guidance, or approval at a critical juncture in a workflow.\n\nUse the specific subclasses:\n- `HumanInTheLoopInputRequestEvent` for free-form text input (popup dialog)\n- `HumanInTheLoopConfirmationRequestEvent` for yes/no confirmation (popup dialog)\n- `HumanInTheLoopChatRequestEvent` for chat-style input (appears as regular message)",
} as const;
...
export const SensitiveInfoRejectEventWritableSchema = {
  ...
  additionalProperties: true,
  type: "object",
  required: ["reason", "cleaned_answer"],
  title: "SensitiveInfoRejectEvent",
  description:
    "Event indicating that the sensitive information guard rejected the response.\n\nThis event is triggered when the sensitive information guard determines that\nthe response contains sensitive or confidential information. The event includes\na cleaned version of the response with the sensitive information removed.",
} as const;
