...
class TestEnvironmentOverrides:
    def test_models_and_flags_come_from_the_environment(self, monkeypatch: pytest.MonkeyPatch):
        ...
        monkeypatch.setenv("DOCUMENT_INGESTION_EMBEDDING_MODEL", "embedding/other")
        monkeypatch.setenv("DOCUMENT_INGESTION_LLM_MODEL", "text-generation/other")
        monkeypatch.setenv("DOCUMENT_INGESTION_WITH_SUMMARY_NODES", "false")
        monkeypatch.setenv("DOCUMENT_INGESTION_OBSERVE_JOB_HOUR", "3")
    ...
    def test_an_out_of_range_schedule_hour_is_rejected(self, monkeypatch: pytest.MonkeyPatch):
        monkeypatch.setenv("DOCUMENT_INGESTION_OBSERVE_JOB_HOUR", "24")
