...
from swiss_ai_hub.core.generative_ai.document.refinement import (
    HeaderAnalysis,
    TableBoundary,
...
from swiss_ai_hub.core.generative_ai.document.refinement.refiner import _refine_single_table
