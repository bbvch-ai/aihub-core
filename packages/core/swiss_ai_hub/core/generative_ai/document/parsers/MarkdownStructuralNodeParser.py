...
from swiss_ai_hub.core.generative_ai.document.loaders.DocumentIntelligenceLoader import PAGE_BREAK
...
class NodeCreatorFromSplits:
    ...
    def _chunk_table(self, child: PageElement, text_chunks: list[TextChunk]) -> list[TextChunk]:
        ...
        Uses shared table utilities from swiss_ai_hub.core.generative_ai.document.tables.
        """
