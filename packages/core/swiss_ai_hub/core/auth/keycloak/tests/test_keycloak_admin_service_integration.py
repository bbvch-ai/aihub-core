...
def _use_real_keycloak_admin(monkeypatch: pytest.MonkeyPatch) -> None:
    """Overrides the session-wide `_create_admin` mock so this file hits real Keycloak."""
    real = _real_admin()
    monkeypatch.setattr(kas_module, "_create_admin", lambda: real)
