...
def mock_database_operations(monkeypatch: pytest.MonkeyPatch):
    ...
    # Apply monkeypatches
    monkeypatch.setattr(
        "swiss_ai_hub.core.persistence.user.UserEntity.UserEntity.ensure_user_exists", mock_ensure_user_exists
    )
    monkeypatch.setattr(
        "swiss_ai_hub.core.persistence.access.entities.TenantEntity.TenantEntity.get_default_tenant",
        mock_get_default_tenant,
    )
    monkeypatch.setattr(
        "swiss_ai_hub.core.persistence.access.entities.UserTenantRoleEntity.UserTenantRoleEntity.create_or_update",
        mock_create_or_update,
    )
    monkeypatch.setattr(
        "swiss_ai_hub.core.auth.dependencies.AuthHandler.AuthHandler.resolve_tenant_for_user", mock_resolve_tenant
    )
    monkeypatch.setattr(
        "swiss_ai_hub.core.auth.dependencies.AuthHandler.AuthHandler.get_default_tenant_for_user", mock_resolve_tenant
    )
