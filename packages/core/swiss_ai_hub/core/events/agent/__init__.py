...
_LLM_MESSAGE_MODULE = "swiss_ai_hub.core.events.agent.semantic.llm.message"
_BITL_REQUEST_EVENT_MODULE = "swiss_ai_hub.core.events.agent.bitl.request.bot_in_the_loop_request_event"
...
_LAZY_IMPORTS: dict[str, str] = {
    ...
    "AudioContent": _LLM_MESSAGE_MODULE,
    ...
    "BotInTheLoopRequestEvent": _BITL_REQUEST_EVENT_MODULE,
    ...
    "ImageContent": _LLM_MESSAGE_MODULE,
    ...
    "SlackConfig": _BITL_REQUEST_EVENT_MODULE,
    ...
    "TeamsConfig": _BITL_REQUEST_EVENT_MODULE,
    "TextContent": _LLM_MESSAGE_MODULE,
