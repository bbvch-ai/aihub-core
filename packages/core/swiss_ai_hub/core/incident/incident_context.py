...
class IncidentContext(BaseModel):
    ...
    occurred_at: Annotated[str, Field(description="When it happened, with the reporter's UTC offset")] = ""
    ...
    environment: Annotated[str, Field(description="Which deployment this is — the version does not say where")] = ""
    agent_class: Annotated[str, Field(description="Agent type, empty for a plain model conversation")] = ""
    agent_name: Annotated[str, Field(description="Agent instance, empty for a plain model conversation")] = ""
    model: Annotated[str, Field(description="LLM behind the answer, where the platform knows it")] = ""
    ...
    locale: Annotated[str, Field(description="Interface language, since some faults appear in only one")] = ""
