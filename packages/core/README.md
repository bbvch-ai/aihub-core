---
title: Swiss AI Hub Library
index: 2
---

# 📚 Swiss AI Hub Library Developer's Guide

[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_lib-core&metric=alert_status&token=fd16708223dbf5307a0ac28f15879abb57a8fc68)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_lib-core)

[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_lib-core&metric=security_rating&token=fd16708223dbf5307a0ac28f15879abb57a8fc68)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_lib-core)

[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_lib-core&metric=vulnerabilities&token=fd16708223dbf5307a0ac28f15879abb57a8fc68)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_lib-core)

[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_lib-core&metric=sqale_rating&token=fd16708223dbf5307a0ac28f15879abb57a8fc68)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_lib-core)

[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_lib-core&metric=ncloc&token=fd16708223dbf5307a0ac28f15879abb57a8fc68)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_lib-core)
...
### 📚 Introduction to `swiss_ai_hub.core`

::: tip Core Principle
You are contributing to the **swiss_ai_hub.core** scope, which serves as the foundational shared library within the
Swiss AI Hub platform. This scope implements core infrastructure and utilities used across all other services. The
...
The `swiss_ai_hub.core` scope is organized as follows:

```
swiss_ai_hub.core/
├── swiss_ai_hub.core/                 # Main package source
...
#### ✅ When to Add to `swiss_ai_hub.core`
...
#### ❌ When NOT to Add to `swiss_ai_hub.core`
...
mechanisms (OAuth2, token-based, etc.) and the Swiss AI Hub's internal user representation.
...
1. **Create Unit Tests**: For specific functionality.
   ...
   import pytest
   from swiss_ai_hub.core.my_domain.MyUtility import MyUtility
...
The Swiss AI Hub uses Pydantic's `BaseSettings` for configuration management rather than `python-dotenv`. This approach
...
::: info Entity Pattern
In the Swiss AI Hub, entity classes serve a dual purpose: they define the database schema using MongoEngine's `Document`
