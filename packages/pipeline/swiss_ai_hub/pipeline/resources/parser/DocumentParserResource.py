...
from swiss_ai_hub.core.generative_ai.document.loaders.DocumentIntelligenceLoader import DocumentIntelligenceLoader
from swiss_ai_hub.core.generative_ai.document.loaders.ImageLoader import ImageLoader
...
from swiss_ai_hub.core.infrastructure.azure_cognitive_services.AzureDocumentIntelligenceSettings import (
...
class DocumentParserResource(ConfigurableResource):
    ...
    .. code-block:: python
        from swiss_ai_hub.pipeline.resources.app.DocumentParserResource import DocumentParserResource, LoaderType
        from swiss_ai_hub.pipeline.resources.data_lake.DataLakeFileSystemResource import DataLakeFileSystemResource
