...
from swiss_ai_hub.core.infrastructure import AzureDataLakeSettings

from swiss_ai_hub.pipeline.resources.data_lake.base.abstract_data_lake_file_system_resource import (
