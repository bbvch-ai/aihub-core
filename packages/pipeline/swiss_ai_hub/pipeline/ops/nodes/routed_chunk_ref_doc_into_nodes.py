...
def routed_chunk_ref_doc_into_nodes(
    ...
    """
    store_name = get_db_name_from_bucket_name(bucket_from_partition_key(context.partition_key))
    parser = node_parser.get_node_parser_for_ref_doc(ref_doc=ref_doc, document_store_name=store_name)
