...
from swiss_ai_hub.pipeline.sensors.nats.per_bucket_observation_sensor_cursor import PerBucketObservationSensorCursor
    ...
    def _sensor(context: SensorEvaluationContext):
        ...
        async def evaluate() -> tuple[str, list[RunRequest | SkipReason]]:
            ...
            try:
                ...
                cursor = PerBucketObservationSensorCursor.from_cursor(context.cursor)
