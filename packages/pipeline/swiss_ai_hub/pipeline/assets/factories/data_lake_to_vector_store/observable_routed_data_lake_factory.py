...
from swiss_ai_hub.pipeline.ops.data_lake.data_version_by_partition_for_routed_data_lake import (
    data_version_by_partition_for_routed_data_lake_no_op,
)
...
def observable_routed_data_lake_factory(
    key: AssetKey,
    ...
    def observable_routed_data_lake(
        ...
        return data_version_by_partition_for_routed_data_lake_no_op(
            context=context,
            asset_key=key,
