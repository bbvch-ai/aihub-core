---
title: Swiss AI Hub Pipelines
index: 5
---

# 🚰 Swiss AI Hub Pipeline Developer's Guide

[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_pipelines-core&metric=alert_status&token=593ae6b9d8cdff5202906c985f89034fb37d8c93)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_pipelines-core)

[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_pipelines-core&metric=security_rating&token=593ae6b9d8cdff5202906c985f89034fb37d8c93)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_pipelines-core)

[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_pipelines-core&metric=vulnerabilities&token=593ae6b9d8cdff5202906c985f89034fb37d8c93)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_pipelines-core)

[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_pipelines-core&metric=sqale_rating&token=593ae6b9d8cdff5202906c985f89034fb37d8c93)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_pipelines-core)

[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_pipelines-core&metric=ncloc&token=593ae6b9d8cdff5202906c985f89034fb37d8c93)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_pipelines-core)
...
### 📚 Introduction to `swiss_ai_hub.pipeline`

You are contributing to the **swiss_ai_hub.pipeline** scope, which contains definitions for data ingestion and
processing pipelines within the Swiss AI Hub platform. This scope implements robust, scalable data processing workflows
using Dagster, handling the complete lifecycle from document ingestion to vector embedding generation for RAG
(Retrieval-Augmented Generation) systems.

### 📁 Project Structure

The `swiss_ai_hub.pipeline` scope is organized as follows:

```
swiss_ai_hub.pipeline/
├── swiss_ai_hub.pipeline/             # Main package source
...
from swiss_ai_hub.pipeline.ops.my_domain.process_my_data import process_my_data
...
from swiss_ai_hub.pipeline.assets.factories.my_domain.my_asset_factory import my_asset_factory
...
The Swiss AI Hub includes a set of ready-to-use pipeline assets designed for frequent tasks:
:::
