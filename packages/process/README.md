---
title: Swiss AI Hub Agentic Process Automation
index: 7
---

# 🔄 Swiss AI Hub Process Developer's Guide

[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_process-core&metric=alert_status&token=0e0aba8b78dd02e4ffecf0ed6470b8b4f65c9c61)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_process-core)

[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_process-core&metric=security_rating&token=0e0aba8b78dd02e4ffecf0ed6470b8b4f65c9c61)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_process-core)

[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_process-core&metric=vulnerabilities&token=0e0aba8b78dd02e4ffecf0ed6470b8b4f65c9c61)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_process-core)

[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_process-core&metric=sqale_rating&token=0e0aba8b78dd02e4ffecf0ed6470b8b4f65c9c61)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_process-core)

[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=swiss-ai-hub_process-core&metric=ncloc&token=0e0aba8b78dd02e4ffecf0ed6470b8b4f65c9c61)](https://sonarcloud.io/summary/new_code?id=swiss-ai-hub_process-core)
...
### 📚 Introduction to `swiss_ai_hub.process`

You are contributing to the **swiss_ai_hub.process** scope, which orchestrates high-level business processes that
involve collaboration between agents, humans, and programs within the Swiss AI Hub platform. This scope implements the
highest tier of Swiss AI Hub's evolution - **Agentic Process Automation** - where workflows are redesigned as dynamic
collaborations between different actors.

### 📁 Project Structure

The `swiss_ai_hub.process` scope is organized as follows:

```
swiss_ai_hub.process/
├── swiss_ai_hub.process/              # Main package source
...
2. **Define Work Events**: Create events that represent work completion by different entities.
   ...
   from swiss_ai_hub.core.nats.events import AgentWorkEvent
   ...
   from swiss_ai_hub.core.nats.events.form import FormGroup
