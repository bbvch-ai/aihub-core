...
class AgentProcessStepDTO(BaseProcessStepDTO):
    ...
    @classmethod
    def from_events(cls, request_event: "PersistedEventDTO", response_event: "PersistedEventDTO | None", step_index: int, t: "LocaleHandler") -> "AgentProcessStepDTO":
        """Creates an AgentProcessStepDTO from request and optional response events."""
        ...
        if response_event:
            ...
            work_response = AgentWorkResponseDTO.from_event_data(
                ...
                t,
                work_request.agent_info,  # Pass agent_info from request
            )
