...
class ProgramProcessStepDTO(BaseProcessStepDTO):
    ...
    @classmethod
    def from_events(cls, request_event: "PersistedEventDTO", response_event: "PersistedEventDTO | None", step_index: int, t: "LocaleHandler") -> "ProgramProcessStepDTO":
        """Creates a ProgramProcessStepDTO from request and optional response events."""
