...
class I18nController(Controller):
    ...
    name = LocaleString(
        en="Language Settings", de="Spracheinstellungen", fr="Paramètres de langue", it="Impostazioni lingua"
    )
    description = LocaleString(
        en="Manage your language preferences",
        de="Verwalten Sie Ihre Spracheinstellungen",
        fr="Gérez vos préférences linguistiques",
        it="Gestisci le tue preferenze linguistiche",
    )
    icon = "mdi:language"
