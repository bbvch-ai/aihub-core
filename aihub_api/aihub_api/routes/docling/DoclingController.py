...
class DoclingController(Controller):
    name = LocaleString(en="Document Converter", de="Dokumentenkonverter", fr="Convertisseur de documents", it="Convertitore di documenti")
    description = LocaleString(en="Convert documents to different formats", de="Dokumente in verschiedene Formate konvertieren", fr="Convertissez des documents en différents formats", it="Converti documenti in formati diversi")
