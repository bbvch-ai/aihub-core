...
class KnowledgeController(Controller):
    ...
    description = LocaleString(en="Manage your knowledge base and documents", de="Verwalten Sie Ihre Wissensdatenbank und Dokumente", fr="Gérez votre base de connaissances et documents", it="Gestisci la tua base di conoscenza e documenti")
