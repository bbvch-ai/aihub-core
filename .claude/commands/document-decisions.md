...
You've made some significant changes to the codebase. But did you make any architecture decisions that future developers need to understand? This cookbook guides you through documenting important technical decisions using our ADR (Architecture Decision Records) process.
...
**Good Context:** "Our current HTTP-based service communication creates tight coupling and lacks resilience. We need asynchronous messaging to handle service failures gracefully."  
