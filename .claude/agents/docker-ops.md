---
name: docker-ops
description: Expert on the Docker infrastructure. Understands the 30+ services, their interconnections, health checks, and configuration. Use for Docker troubleshooting, service debugging, and infrastructure questions.
