...
**Theme file**: `packages/web/themes/aihub-theme.ts`
...
**Base**: 14px (`packages/web/assets/css/main.css`), system font stack.
...
| File                                 | Purpose                                    |
| ------------------------------------ | ------------------------------------------ |
| `packages/web/themes/aihub-theme.ts` | PrimeVue theme preset (surface scale)      |
| `packages/web/tailwind.config.mjs`   | Tailwind extensions (surface-850, plugins) |
| `packages/web/assets/css/main.css`   | Base font size (14px) and font stack       |
| `packages/web/nuxt.config.ts`        | PrimeVue module config, auto-imports       |
