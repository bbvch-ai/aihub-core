...
```bash
cd packages/web/swiss_ai_hub_web && pnpm dev
```
...
2. Verify the OIDC plugin is configured: `packages/web/swiss_ai_hub_web/plugins/oidc-client.ts`
...
2. Check locale files: `packages/web/swiss_ai_hub_web/i18n/locales/en.yaml`
...
1. Find the page component: `packages/web/swiss_ai_hub_web/pages/service/{resource}/`
2. Find composables: `packages/web/swiss_ai_hub_web/composables/{resource}/`
3. Find child components: `packages/web/swiss_ai_hub_web/components/{Resource}/`
4. Check SDK types: `packages/web/swiss_ai_hub_web/sdk/client/`
