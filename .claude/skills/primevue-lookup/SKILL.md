...
1. Search in `packages/web/components/` and `packages/web/pages/` for the component tag name (e.g., `<DataTable`,
   `<Dialog`)
...
Read the project theme: `packages/web/themes/aihub-theme.ts`
...
3. Check that i18n keys used in the example exist in `packages/web/i18n/locales/en.yaml`
