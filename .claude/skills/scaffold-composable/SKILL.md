...
- Simple query: `packages/web/aihub_web/composables/agent/useAgentInstances.ts`
- Query with route params: `packages/web/aihub_web/composables/agent/useAgentInstance.ts`
- Mutation with cache invalidation: `packages/web/aihub_web/composables/agent/useCreateAgentInstance.ts`
- Delete mutation: `packages/web/aihub_web/composables/agent/useDeleteAgentInstance.ts`

## Step 1: Check SDK Availability

Find the SDK functions and types for the resource in `packages/web/aihub_web/sdk/client/`. Identify:
...
```
packages/web/aihub_web/composables/{resource}/
...
1. Ensure composable files are in `packages/web/aihub_web/composables/{resource}/` for Nuxt auto-import
...
**Result**: Creates composable files in `packages/web/aihub_web/composables/pipeline/`:
...
- **`enabled`**: Use `useRouteReady()` when query depends on route params (defined at
  `packages/web/aihub_web/composables/useRouteReady.ts`)
