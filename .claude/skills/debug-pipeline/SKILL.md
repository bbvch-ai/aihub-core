...
2. **Key entry point**: The `Definitions` object in the pipeline module (usually `__init__.py` or a file using
...
- `/debug-pipeline sensor not firing` -- Check sensor is in Definitions, verify NATS connectivity, check
  minimum_interval
