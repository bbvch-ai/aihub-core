...
2. Study these reference pages:
   - Simple list: `packages/web/swiss_ai_hub_web/pages/service/roles.vue`
   - Complex list with grouping: `packages/web/swiss_ai_hub_web/pages/service/agents.vue`
   - Knowledge list: `packages/web/swiss_ai_hub_web/pages/service/knowledge.vue`

## Step 1: Check SDK Availability

Search `packages/web/swiss_ai_hub_web/sdk/client/` for the resource's SDK functions and DTO types. If they don't exist,
warn the user to run `/generate-sdk` first.

Look up the actual DTO type name in `packages/web/swiss_ai_hub_web/sdk/client/types.gen.ts` — types may be named
...
Create `packages/web/swiss_ai_hub_web/pages/service/{resource}s.vue`:
...
Create `packages/web/swiss_ai_hub_web/components/{Resource}/Card.vue` following this exact pattern:
...
Add translation keys in all 4 locale files (`packages/web/swiss_ai_hub_web/i18n/locales/{de,en,fr,it}.yaml`):
...
1. `packages/web/swiss_ai_hub_web/pages/service/pipelines.vue` -- List page with card grid
2. `packages/web/swiss_ai_hub_web/components/Pipeline/Card.vue` -- Resource card component
3. `packages/web/swiss_ai_hub_web/composables/pipeline/usePipelines.ts` -- List query composable
4. `packages/web/swiss_ai_hub_web/composables/pipeline/useCreatePipeline.ts` -- Create mutation composable
