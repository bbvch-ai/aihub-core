...
gateway within the Swiss AI Hub platform. This scope implements HTTP endpoints and real-time communication that connect
frontend applications to the underlying Swiss AI Hub services.
