...
The Swiss AI Hub Pipeline SDK is built on [Dagster](https://docs.dagster.io/). This page introduces the essential
building blocks that form every pipeline.
...
- To reduce boilerplate and enforce consistency, the SDK relies heavily on the **factory pattern**. Instead of writing
  ...
  `rag_pipeline_definitions`) that generate fully configured pipeline components for you.
