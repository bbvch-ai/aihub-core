...
### Step 2: Install the Swiss AI Hub CLI
...
databases, and the Swiss AI Hub platform components.
...
- Open `http://localhost:8080` - You should see the Swiss AI Hub web interface
...
Visit `http://localhost:6006` to see Langfuse tracing. You'll see detailed traces of your agent's execution, showing
