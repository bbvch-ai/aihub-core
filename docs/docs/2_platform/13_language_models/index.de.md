...
LLM-Proxy-Schicht: Bietet ein einheitliches Gateway zu Sprachmodell-Anbietern. Siehe [Proxy-Server](./1_proxy_server/) für Routing, Kostenverfolgung und Wiederholungsversuche.

Agenten-Schicht: Agents implementieren Workflows mithilfe von LLMs über den Proxy. Siehe [Guards](./3_guards/) für Eingabe- und Ausgabevalidierung.
