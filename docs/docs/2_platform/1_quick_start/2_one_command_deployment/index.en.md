...
- **Production Deployment**: Deploy to a server with a real domain name (e.g., `swiss-ai-hub.yourcompany.com`)
...
1. **Domain** — Set `DOMAIN` to your production domain (e.g., `swiss-ai-hub.yourcompany.com`) or `127.0.0.1.nip.io` for
   local testing
