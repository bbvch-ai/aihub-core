...
The Swiss AI Hub uses defense-in-depth network security. Multiple independent layers protect the platform, its data, and
its users.

All internal services (Swiss AI Hub API, Web UI, LiteLLM Proxy, databases) run in isolated Docker containers on private
...
- [Infrastructure layers](../../../1_vision_and_positioning/4_infrastructure_layers/) - Infrastructure component
  overview
