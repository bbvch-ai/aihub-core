...
Die Swiss AI Hub-Plattform trennt Agent-Definitionen von ihren Konfigurationen. Dies ermöglicht Administratoren, mehrere angepasste Versionen desselben Agent-Typs zu erstellen, ohne Codeänderungen vornehmen zu müssen.
