...
| `MEM0_SEARCH_QUERY_MAX_TOKENS` | `Mem0Settings.SEARCH_QUERY_MAX_TOKENS` | `None` |  | Token budget for search queries before truncation. None resolves the embedding model's max input tokens from LiteLLM at first use. |
