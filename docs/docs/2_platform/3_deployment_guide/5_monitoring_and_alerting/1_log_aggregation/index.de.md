...
GB Speicher) deployed werden. Der OTel Collector des Swiss AI Hub wird dann so konfiguriert, dass er auf den selbst
gehosteten Endpunkt anstatt auf SigNoz Cloud verweist.
