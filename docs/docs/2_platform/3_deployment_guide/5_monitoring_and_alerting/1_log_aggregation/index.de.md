...
- Lesen Sie die [OpenTelemetry Collector-Dokumentation](https://opentelemetry.io/docs/collector/) für erweiterte Konfigurationen.
- Konfigurieren Sie die [Langfuse LLM Observability](/de/docs/10_chat_ui/10_observability/) für KI-spezifisches Debugging.
