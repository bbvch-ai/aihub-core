...
Sie können den Swiss AI Hub mittels VM-Snapshots oder Komponenten-Level-Backups sichern.
...
Stoppen Sie Swiss AI Hub-Services vor dem Erstellen eines Snapshots mit `docker compose down`. Alternativ verwenden Sie
