...
from aihub.app.constants.node_metadata import HEADING_LEVEL, NODE_LANGUAGE_ENGLISH, NODE_TYPE_SUMMARY, TYPE
...
class RecursiveNodeSummarizer:
    ...
    def _create_summary_node(original_node: TextNode, summary: str, level: int = 0) -> TextNode:
        summary_node = TextNode(
            text=summary,
            metadata={**original_node.metadata, TYPE: NODE_TYPE_SUMMARY, HEADING_LEVEL: level},
            relationships={},
        )
