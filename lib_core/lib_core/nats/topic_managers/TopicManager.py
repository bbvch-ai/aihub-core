class TopicManager:
    ...
    def get_subject_for_specific_event_in_agent(
        ...
        return f"agent.{agent_class}.{agent_id}.{thread_id}.{display_id}.{run_id}.{event_type}.{event_name}"
    ...
    def get_stream_name_for_all_events_in_agent(self) -> str:
        return f"agent_stream"

    def get_stream_group_for_all_events_in_agent(self):
        return f"{self.get_stream_name_for_all_events_in_agent()}_queue_group"

    def get_stream_group_for_all_control_events_in_agent(self):
        return f"{self.get_stream_name_for_all_events_in_agent()}_{self.CONTROL_EVENT}_queue_group"

    def get_stream_group_for_all_display_events_in_agent(self):
