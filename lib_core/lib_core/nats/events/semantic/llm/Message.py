...
class Message(BaseModel):
    role: str = Field(..., description="The role of the message, such as 'user', 'assistant', or 'system'.")
    ...
    function_call_name: Optional[str] = Field(
        None,
        description="The name of the function being called in the message."
    )
    function_call_arguments_json: Optional[Dict] = Field(
        None,
