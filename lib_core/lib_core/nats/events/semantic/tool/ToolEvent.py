...
from openinference.semconv.trace import SpanAttributes, ToolAttributes, OpenInferenceSpanKindValues
...
class ToolEvent(SemanticEvent):
    ...
    json_schema: Optional[Dict] = Field(None, description="The json schema of a tool input")
    parameters: Optional[Dict] = Field(None, description="The parameters definition for invoking the tool")
