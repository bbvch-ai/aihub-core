...
from lib_core.infrastructure.azure.cognitive_services.CognitiveServiceAccess import (
    CognitiveServiceAccess,
)
from lib_core.infrastructure.azure.cognitive_services.speech_service.SpeechServiceConfig import (
    SpeechServiceConfig,
)
