...
from aihub_pipeline.ops.share_point.extract_metadata_from_sharepoint_file import extract_metadata_from_share_point_file
...
def sharepoint_files_to_data_lake_files_factory(
    ...
    @graph_asset(
        ...
        ins={"sharepoint_file": AssetIn(key=share_point_key)},
    ...
    def data_lake_file(
        ...
        uri = extract_uri_from_share_point_file(sharepoint_file=sharepoint_file)
        metadata = extract_metadata_from_share_point_file(sharepoint_file)
        content = extract_content_from_share_point_file(sharepoint_file)
