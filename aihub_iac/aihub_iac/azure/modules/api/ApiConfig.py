...
class ApiConfig(BaseSettings):
    API_APP_SERVICE_PLAN_NAME: str = Field(..., description="name of the app service plan to use for the api")
    API_REPO_IMAGE_URL: str = Field(..., description="URL where the image for the api is stored")
    API_IMAGE_TAG: str = Field(..., description="image tag for the api")
    ...
    API_ANONYM_NAME: str = Field(..., description="-")
    API_ANONYM_EMAIL: str = Field(..., description="-")
    API_ANONYM_ROLES: str = Field(..., description="-")
    API_ANONYM_OID: str = Field(..., description="-")
