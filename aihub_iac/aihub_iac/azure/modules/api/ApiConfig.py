from typing import Annotated, ClassVar, Optional, Dict, Union
...
class ApiConfig(BaseConfig):
    ...
    # OAuth2 settings
    client_id: Annotated[
        str, Field(default_factory=lambda: ApiConfig._oauth_settings.CLIENT_ID, description="Client ID")
    ]
    tenant_id: Annotated[
        str, Field(default_factory=lambda: ApiConfig._oauth_settings.TENANT_ID, description="Tenant ID")
    ]
