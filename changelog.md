...
- 🌐 **WebSocket Event Payload Structure**: Modified the `WSServerAgentEvent` payload to use strongly-typed Pydantic models for the `event` field, enhancing data integrity and enabling the frontend to dynamically render diverse event types with full data.
