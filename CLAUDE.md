...
To continuously improve `CLAUDE.md` by incorporating new knowledge gained during your development tasks. This document is the "persistent memory" of our project, and you are its primary curator.
...
3.  **Reflect and Compare**: Critically compare your recent experience against the information in this document. Ask yourself the following questions:
      ...
      * **Was something wrong?** Did I find a rule or description in these `CLAUDE.md` that contradicts the actual implementation in the codebase? (e.g., a linter rule changed, or a dependency was removed).
...
4.  **Take Action**:
      * **If a change is needed**:
          * Identify the exact section to modify within `CLAUDE.md`.
          ...
          * In your final message to the user, you can briefly mention that you have also updated the project `CLAUDE.md`.
      * **If no change is needed**:
          * It is perfectly acceptable to conclude that the `CLAUDE.md` are up-to-date. Do not force an edit if none is necessary.
