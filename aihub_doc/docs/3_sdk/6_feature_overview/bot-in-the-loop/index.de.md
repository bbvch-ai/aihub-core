...
Die **Ereignisgesteuerte Orchestrierung** treibt die gesamte Interaktion durch das Ereignissystem des AI-Hubs an:
...
1. **Azure Bot Service Konfiguration**: Stellen Sie sicher, dass Ihr AI-Hub über eine konfigurierte Azure Bot
...
3. **NATS Ereignisverteilung**: Stellen Sie sicher, dass Ihr AI-Hub-Deployment für das Nachrichten-Routing über NATS
   Messaging konfiguriert ist
...
Um Bot-in-the-Loop in Ihrem AI-Hub-Deployment zu implementieren:
...
sowie das AI-Hub Agenten-Entwicklerhandbuch für umfassende Anweisungen zur Workflow-Integration.
