...
Erstellen Sie Ihre erste Datenverarbeitungs-Pipeline mit dem AI-Hub Pipeline (`aihub_pipeline`) SDK – eine vollständige Datenintegrations-Pipeline mit mehreren verbundenen Assets.
...
- **AI-Hub SDK-Nutzung**: Verwendung von Fabriken, Ressourcen und typisierten Datenobjekten aus `aihub_pipeline`
