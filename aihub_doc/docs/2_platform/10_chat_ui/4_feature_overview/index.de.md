...
pflegen, frühere Konversationen effizient finden und wieder aufnehmen.

**Markdown- und LaTeX-Unterstützung**: Das vollständige Markdown-Rendering ermöglicht Rich-Text-Formatierungen in sowohl
Benutzernachrichten als auch KI-Antworten – Überschriften, Listen, Tabellen, Codeblöcke mit Syntaxhervorhebung. Die
LaTeX-Unterstützung ermöglicht mathematische Notation, die für technische und wissenschaftliche Anwendungen von
...
Bild-Upload, die Vorschau und die Integration in Konversationsabläufe.

## Modellverwaltung

Die Oberfläche bietet umfassende Funktionen zur Verwaltung der KI-Modellauswahl und -konfiguration.

**Multi-Modell-Unterstützung**: Benutzer können mit mehreren KI-Modellen innerhalb derselben Oberfläche interagieren und
Modelle basierend auf Fähigkeitsanforderungen, Kostenüberlegungen oder Leistungsmerkmalen auswählen. Der Modellwechsel
erfolgt nahtlos ohne Anwendungsänderungen.

**Modellparameterkontrolle**: Fortgeschrittene Benutzer können Modellparameter anpassen – Temperatur zur
...
Integrierte RAG-Funktionen ermöglichen KI-Interaktionen, die durch benutzerdefinierte Wissensbasen informiert werden.

**Dokumentenintegration**: Organisationen können KI-Modellen Zugang zu benutzerdefinierten Dokumentensammlungen
ermöglichen – technische Dokumentation, Richtlinien, Verfahren, Wissensdatenbanken. Die Oberfläche übernimmt den
Dokumenten-Upload, die Verarbeitung und die Abrufkonfiguration.

**Kontextbewusste Antworten**: Wenn RAG-Funktionen aktiviert sind, integrieren KI-Antworten Informationen aus
konfigurierten Wissensbasen und liefern so Antworten, die auf organisatorischem Wissen basieren und nicht auf
generischen Trainingsdaten. Diese Verankerung verbessert die Relevanz und Genauigkeit der Antworten dramatisch.

**Quellenindikatoren**: Die native Oberfläche bietet Indikatoren, wenn Antworten abgerufene Informationen enthalten,
obwohl die erweiterte Quellenattribution des Swiss AI Hub diese Funktionen, wie im eigenen Attributionsabschnitt
dokumentiert, erheblich erweitert.

**Wissensbasisverwaltung**: Administratoren können Dokumentensammlungen verwalten, Abrufparameter konfigurieren und die
Nutzung der Wissensbasis über integrierte Verwaltungsoberflächen überwachen.
...
teilen und von erfolgreichen KI-Anwendungen der Kollegen lernen.

**Workspace-Kollaboration**: Mehrere Benutzer können in gemeinsamen Arbeitsbereichsumgebungen arbeiten, auf gemeinsame
Konversationshistorien, geteilte Wissensbasen und kollaborative KI-Interaktionen zugreifen, die teambasierte
Arbeitsmuster unterstützen.

## Administration und Sicherheit

Umfassende administrative Funktionen unterstützen die Anforderungen an Unternehmensbereitstellung und Governance.

**Rollenbasierte Zugriffskontrolle**: Administratoren definieren Benutzerrollen mit granularen Berechtigungen, die den
Zugriff auf bestimmte Modelle, Funktionen oder administrative Funktionen steuern. Dieses Rollensystem ermöglicht eine
...
Startbildschirm, ohne eine App-Store-Verteilung zu erfordern.

**Tastaturkürzel**: Power-User profitieren von einer umfassenden Tastaturnavigation, die einen effizienten Betrieb ohne
Mausinteraktion ermöglicht. Tastenkombinationen beschleunigen gängige Operationen wie das Senden von Nachrichten, das
Wechseln von Konversationen oder den Zugriff auf Einstellungen.

**Emoji-Unterstützung**: Die vollständige Emoji-Unterstützung ermöglicht eine ausdrucksstarke Kommunikation, wobei
Emoji-Auswahlen und -Rendering den konversationsbezogenen Ton und die visuelle Kommunikation über Text hinaus
unterstützen.

**Themenanpassung**: Benutzer können aus mehreren visuellen Themen wählen – Light Mode, Dark Mode, Optionen mit hohem
Kontrast – und das Erscheinungsbild der Oberfläche an persönliche Vorlieben und Umgebungslichtbedingungen anpassen.

## Erweiterte Funktionen

Zusätzliche hochentwickelte Funktionen adressieren spezialisierte Anwendungsfälle und fortgeschrittene Anforderungen.

**Code-Ausführung**: Für unterstützte Modelle und Konfigurationen kann die Oberfläche Code-Snippets ausführen, was
interaktive Programmierunterstützung, computergestützte Problemlösung und Algorithmus-Prototyping in
Konversationskontexten ermöglicht.

**Diagramm-Rendering**: Die Mermaid-Diagramm-Unterstützung ermöglicht KI-generierte Visualisierungen – Flussdiagramme,
Sequenzdiagramme, Zustandsautomaten –, die direkt in Konversationen gerendert werden. Diese Funktion unterstützt
...
Anforderungen an die Unternehmensstrenge erfüllen – eine Kombination, die bei Plattformen, die sich für vollständig
benutzerdefinierte Entwicklungspfade entscheiden, selten verfügbar ist.
