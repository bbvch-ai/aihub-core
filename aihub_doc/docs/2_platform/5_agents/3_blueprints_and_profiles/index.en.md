...
The AI-Hub platform separates agent definitions from their configurations. This lets administrators create multiple
customized versions of the same agent type without requiring code changes.
