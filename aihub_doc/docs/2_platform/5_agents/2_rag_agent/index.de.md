...
Der AI-Hub bietet kein Modelltraining oder Fine-Tuning an. Stattdessen greift der RAG-Agent auf aktuelle Informationen
zu, indem er diese zum Zeitpunkt der Abfrage aus Ihrer Wissensbasis abruft. Dies bedeutet, dass der Agent automatisch
über neue oder aktualisierte Dokumente "Bescheid weiß", ohne dass ein erneuter Trainingsprozess erforderlich ist.
:::
