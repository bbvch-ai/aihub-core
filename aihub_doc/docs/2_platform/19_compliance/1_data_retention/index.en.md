...
Execution-specific data provides a fixed 30-day window for debugging. Conversational memory uses a sliding
...
capacity-based (10 million messages) limits. In high-throughput deployments, events may be deleted before the
