...
For organizations hosting in Switzerland, this simplifies compliance with both GDPR and Swiss DSG requirements. See [Deployment Options](../../3_deployment_guide/1_deployment_options/) for hosting configurations.
