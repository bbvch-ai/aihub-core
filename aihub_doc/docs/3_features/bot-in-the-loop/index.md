...
::: info **TL;DR - What is Bot-in-the-Loop?** Bot-in-the-Loop enables AI agents to **seamlessly pause workflows and
request human input via Slack channels**, then automatically continue execution with the human response. This pattern
bridges the gap between autonomous AI processing and human expertise, allowing agents to handle complex decisions while
