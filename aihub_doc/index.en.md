...
for **compliance and auditing**. Explore these features under
...
[Language Models](/aihub-core/docs/2_platform/13_language_models/).
:::
...
budgets to prevent unexpected costs. Learn more about [Cost Control](/aihub-core/docs/2_platform/14_cost_control/).
:::
...
secure network perimeter. Review our comprehensive [Security features](/aihub-core/docs/2_platform/18_security/).
:::
...
See [Our Solution](/aihub-core/docs/1_vision_and_positioning/1_introduction/2_our_solution/).
:::
...
[Data Pipelines](/aihub-core/docs/2_platform/6_pipelines/) to ingest documents from your sources (like SharePoint).
These pipelines securely process the documents and index them in a vector database *that you own and control*, allowing
agents to access company knowledge safely.
:::
...
[OpenAI-Compatible API](/aihub-core/docs/2_platform/16_api/1_openai_compatible_api/) allowing integration with many
existing tools, helping to **reduce fragmentation**.
:::
...
[Pipelines section](/aihub-core/docs/2_platform/6_pipelines/).
:::
...
sufficient, ensuring **reliable, fact-based responses**. Learn more about
[Agents](/aihub-core/docs/2_platform/5_agents/).
:::
...
[Agent Fundamentals](/aihub-core/docs/3_sdk/2_building_agents/1_agent_fundamentals/) which enable these patterns.
:::
...
systems can trigger agents via the platform's
[Agent Interaction API](/aihub-core/docs/2_platform/16_api/2_agent_interaction_api/); automated Data Pipelines can sync
knowledge from sources like SharePoint; and standard protocols are supported for custom connections. See
...
scratch or managing intricate cloud vendor services. Check the
[Quick Start](/aihub-core/docs/2_platform/1_quick_start/).
:::
