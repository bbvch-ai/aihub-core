...
Used during deserialization to decide which subclass to instantiate.`,
  ...
  additionalProperties: true,
  type: "object",
  required: ["model_name", "content", "_type", "_parent_class_names"],
  title: "ChunkEvent",
...
Used during deserialization to decide which subclass to instantiate.`,
  ...
  required: ["_type", "_parent_class_names"],
  title: "CostEvent",
  description: `An abstract base class representing a cost-related event visible to end-users or
...
Used during deserialization to decide which subclass to instantiate.`,
  ...
  additionalProperties: true,
  type: "object",
  required: ["content", "_type", "_parent_class_names"],
  title: "ThoughtEvent",
