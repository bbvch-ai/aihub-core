...
export const ToolCallBlock_InputSchema = {
    properties: {
        ...
        tool_kwargs: {
            anyOf: [
                {
                    '$ref': '#/components/schemas/tool_kwargs'
                },
                {
                    type: 'string'
                }
...
export const UsageLimitDTOSchema = {
    properties: {
        pattern: {
            type: 'string',
            title: 'Pattern',
            description: "Full dotted resource pattern with wildcards (e.g. 'aihub.user.agent.>', 'aihub.user.process.MyProcess.*'). Legacy patterns without 'aihub.user.' prefix are auto-normalized to 'aihub.user.agent.<pattern>'."
        },
        limit: {
            type: 'integer',
            title: 'Limit',
...
export const tool_kwargsSchema = {
    properties: {},
    type: 'object',
    title: 'tool_kwargs'
} as const;
