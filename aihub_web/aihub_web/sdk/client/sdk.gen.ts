 ...
 */
export const getNamespaces = <TComposable extends Composable, DefaultT extends GetNamespacesResponse = GetNamespacesResponse>(options: Options<TComposable, GetNamespacesData, GetNamespacesResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetNamespacesResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
