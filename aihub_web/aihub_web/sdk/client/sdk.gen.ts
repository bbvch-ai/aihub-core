 ...
 */
export const deleteAllMemories = <TComposable extends Composable, DefaultT extends DeleteAllMemoriesResponse2 = DeleteAllMemoriesResponse2>(options: Options<TComposable, DeleteAllMemoriesData, DeleteAllMemoriesResponse2, DefaultT>) => {
    return (options.client ?? _heyApiClient).delete<TComposable, DeleteAllMemoriesResponse2 | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getMemories = <TComposable extends Composable, DefaultT extends GetMemoriesResponse = GetMemoriesResponse>(options: Options<TComposable, GetMemoriesData, GetMemoriesResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetMemoriesResponse | DefaultT, GetMemoriesError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const searchMemories = <TComposable extends Composable, DefaultT extends SearchMemoriesResponse = SearchMemoriesResponse>(options: Options<TComposable, SearchMemoriesData, SearchMemoriesResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, SearchMemoriesResponse | DefaultT, SearchMemoriesError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const deleteMemory = <TComposable extends Composable, DefaultT extends DeleteMemoryResponse2 = DeleteMemoryResponse2>(options: Options<TComposable, DeleteMemoryData, DeleteMemoryResponse2, DefaultT>) => {
    return (options.client ?? _heyApiClient).delete<TComposable, DeleteMemoryResponse2 | DefaultT, DeleteMemoryError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const updateMemory = <TComposable extends Composable, DefaultT extends UpdateMemoryResponse2 = UpdateMemoryResponse2>(options: Options<TComposable, UpdateMemoryData, UpdateMemoryResponse2, DefaultT>) => {
    return (options.client ?? _heyApiClient).patch<TComposable, UpdateMemoryResponse2 | DefaultT, UpdateMemoryError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Send User Message Event To User Memory Agent Memory Agent
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventPost = <TComposable extends Composable, DefaultT extends SendUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventPostResponse = SendUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventPostResponse>(options: Options<TComposable, SendUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventPostData, SendUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventPostResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SendUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventPostResponse | DefaultT, SendUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Stream User Message Event To User Memory Agent Memory Agent
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventStreamPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, StreamUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventStreamPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, StreamUserMessageEventToUserMemoryAgentMemoryAgentAgentsUserMemoryAgentMemoryAgentUserMessageEventStreamPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
