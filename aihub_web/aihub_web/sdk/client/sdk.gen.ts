 ...
 */
export const getModelsByMode = <TComposable extends Composable, DefaultT extends GetModelsByModeResponse = GetModelsByModeResponse>(options: Options<TComposable, GetModelsByModeData, GetModelsByModeResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetModelsByModeResponse | DefaultT, GetModelsByModeError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
