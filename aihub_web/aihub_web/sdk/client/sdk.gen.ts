 ...
 */
export const status = <TComposable extends Composable, DefaultT extends StatusResponse = StatusResponse>(options: Options<TComposable, StatusData, StatusResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, StatusResponse | DefaultT, unknown, DefaultT>({
        url: '/models/',
        ...options
    });
};
 ...
 */
export const modelList = <TComposable extends Composable, DefaultT extends ModelListResponse = ModelListResponse>(options: Options<TComposable, ModelListData, ModelListResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, ModelListResponse | DefaultT, unknown, DefaultT>({
...
/**
 * Send User Message Event To R A G Agent Dev Agent
 * Send a specific event type to a specific agent. Returns any possible stop event type.
 */
export const sendUserMessageEventToRAGAgentDevAgentAgentsRagAgentDevAgentUserMessageEventPost = <TComposable extends Composable, DefaultT extends SendUserMessageEventToRagAgentDevAgentAgentsRagAgentDevAgentUserMessageEventPostResponse = SendUserMessageEventToRagAgentDevAgentAgentsRagAgentDevAgentUserMessageEventPostResponse>(options: Options<TComposable, SendUserMessageEventToRagAgentDevAgentAgentsRagAgentDevAgentUserMessageEventPostData, SendUserMessageEventToRagAgentDevAgentAgentsRagAgentDevAgentUserMessageEventPostResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SendUserMessageEventToRagAgentDevAgentAgentsRagAgentDevAgentUserMessageEventPostResponse | DefaultT, SendUserMessageEventToRagAgentDevAgentAgentsRagAgentDevAgentUserMessageEventPostError, DefaultT>({
