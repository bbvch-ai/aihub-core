...
import type { GetHealthData, GetHealthResponse, GetSuiteData, GetSuiteResponse, GetMyUserData, GetMyUserResponse, GetUserData, GetUserResponse, GetUserError, GetUsersData, GetUsersResponse, GetUsersError, GetMyDashboardData, GetMyDashboardResponse, UpdateMyDashboardData, UpdateMyDashboardResponse, UpdateMyDashboardError, GetLocaleData, GetLocaleResponse, GetAgentEventsInThreadData, GetAgentEventsInThreadResponse, GetAgentEventsInThreadError, GetAgentEventTimeseriesData, GetAgentEventTimeseriesResponse, GetAgentEventTimeseriesError, GetUserThreadsData, GetUserThreadsResponse, GetUserThreadsError, CreateThreadData, CreateThreadResponse, CreateThreadError, GetThreadData, GetThreadResponse, GetThreadError, AddAgentToThreadData, AddAgentToThreadResponse, AddAgentToThreadError, RemoveAgentFromThreadData, RemoveAgentFromThreadResponse, RemoveAgentFromThreadError, AddUserToThreadData, AddUserToThreadResponse, AddUserToThreadError, RemoveUserFromThreadData, RemoveUserFromThreadResponse, RemoveUserFromThreadError, GetAgentData, GetAgentResponse, GetAgentError, GetAgentThreadsData, GetAgentThreadsResponse, GetAgentThreadsError, GetAgentsData, GetAgentsResponse, DiscoverAgentsData, DiscoverAgentsResponse, GetProcessData, GetProcessResponse, GetProcessError, GetProcessesData, GetProcessesResponse, DiscoverProcessesData, DiscoverProcessesResponse, GetProcessStartFormsData, GetProcessStartFormsResponse, GetProcessStartFormsError, GetProcessOpenFormsData, GetProcessOpenFormsResponse, GetProcessOpenFormsError, SendProcessStartFormData, SendProcessStartFormResponse, SendProcessStartFormError, SendProcessOpenFormData, SendProcessOpenFormResponse, SendProcessOpenFormError, ListTokensEndpointData, ListTokensEndpointResponse, CreateTokenEndpointData, CreateTokenEndpointResponse, CreateTokenEndpointError, RevokeTokenEndpointData, RevokeTokenEndpointResponse, RevokeTokenEndpointError, DeleteRoleData, DeleteRoleResponse2, DeleteRoleError, GetRoleData, GetRoleResponse, GetRoleError, UpdateRoleData, UpdateRoleResponse, UpdateRoleError, GetRolesData, GetRolesResponse, CreateRoleData, CreateRoleResponse, CreateRoleError, GetModelsData, GetModelsResponse, GetModelData, GetModelResponse, GetModelError, GetEmbeddingsData, GetEmbeddingsResponse, GetEmbeddingsError, ChatCompletionData, ChatCompletionResponse, ChatCompletionError, GenerateImageData, GenerateImageResponse, GenerateImageError, CreateTranscriptionData, CreateTranscriptionResponse, CreateTranscriptionError, CreateSpeechData, CreateSpeechError, GetDatasetsData, GetDatasetsResponse, CreateDatasetData, CreateDatasetResponse, CreateDatasetError, GetDatasetData, GetDatasetResponse, GetDatasetError, UpdateDatasetData, UpdateDatasetResponse, UpdateDatasetError, GetExperimentData, GetExperimentResponse, GetExperimentError, GetExperimentsData, GetExperimentsResponse, RunExperimentData, RunExperimentResponse, RunExperimentError, CreateNamespaceData, CreateNamespaceResponse, CreateNamespaceError, UpdateNamespaceData, UpdateNamespaceResponse, UpdateNamespaceError, GetDatabasesData, GetDatabasesResponse, GetDocumentsForNamespaceData, GetDocumentsForNamespaceResponse, GetDocumentsForNamespaceError, GetDocumentByIdData, GetDocumentByIdResponse, GetDocumentByIdError, GetNodesForDocumentData, GetNodesForDocumentResponse, GetNodesForDocumentError, GetSummaryNodesForDocumentData, GetSummaryNodesForDocumentResponse, GetSummaryNodesForDocumentError, InitiateDocumentUploadData, InitiateDocumentUploadResponse, InitiateDocumentUploadError, ValidateDocumentUploadData, ValidateDocumentUploadResponse, ValidateDocumentUploadError, GetSupportedFileTypesData, GetSupportedFileTypesResponse, GetFileUrlData, GetFileUrlResponse, GetFileUrlError, GetFileRedirectData, GetFileRedirectError, GetAnonymousFileUrlData, GetAnonymousFileUrlError, GetAnonymousFileRedirectData, GetAnonymousFileRedirectError, GetNotificationsData, GetNotificationsResponse, GetNotificationsError, UpdateNotificationsBulkData, UpdateNotificationsBulkResponse, UpdateNotificationsBulkError, UpdateNotificationData, UpdateNotificationResponse, UpdateNotificationError, ProcessDocumentData, ProcessDocumentResponse, GetQuestionsByStatusData, GetQuestionsByStatusResponse, GetQuestionsByStatusError, GetPendingQuestionsData, GetPendingQuestionsResponse, GetPendingQuestionsError, GetPendingCountData, GetPendingCountResponse, GetPendingCountError, GetQuestionData, GetQuestionResponse, GetQuestionError, SubmitAnswerData, SubmitAnswerResponse, SubmitAnswerError, CancelQuestionData, CancelQuestionResponse, CancelQuestionError, GetGroupsData, GetGroupsResponse, CreateGroupData, CreateGroupResponse, CreateGroupError, DeleteGroupData, DeleteGroupResponse, DeleteGroupError, GetGroupData, GetGroupResponse, GetGroupError, UpdateGroupData, UpdateGroupResponse, UpdateGroupError, RemoveMemberData, RemoveMemberResponse, RemoveMemberError, AddMemberData, AddMemberResponse, AddMemberError, SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostData, SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostResponse, SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostError, StreamUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventStreamPostData, StreamUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventStreamPostError, SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostData, SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostResponse, SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostError, StreamInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventStreamPostData, StreamInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventStreamPostError, SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostData, SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostResponse, SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostError, StreamAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventStreamPostData, StreamAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventStreamPostError, SendUserMessageEventToRagAgentRagAgentAgentsRagAgentRagAgentUserMessageEventPostData, SendUserMessageEventToRagAgentRagAgentAgentsRagAgentRagAgentUserMessageEventPostResponse, SendUserMessageEventToRagAgentRagAgentAgentsRagAgentRagAgentUserMessageEventPostError, StreamUserMessageEventToRagAgentRagAgentAgentsRagAgentRagAgentUserMessageEventStreamPostData, StreamUserMessageEventToRagAgentRagAgentAgentsRagAgentRagAgentUserMessageEventStreamPostError, SendHumanInTheLoopResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventPostData, SendHumanInTheLoopResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventPostError, StreamHumanInTheLoopResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventStreamPostData, StreamHumanInTheLoopResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventStreamPostError, GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetData, GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetResponse, GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetError, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostData, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostResponse, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostError, GetFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAGetData, GetFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAGetResponse, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostData, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostResponse, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostError } from './types.gen';
import { client as _heyApiClient } from './client.gen';
import { getMyUserResponseTransformer, getUserResponseTransformer, getUsersResponseTransformer, getAgentEventTimeseriesResponseTransformer, listTokensEndpointResponseTransformer, createTokenEndpointResponseTransformer, getDatasetsResponseTransformer, createDatasetResponseTransformer, getDatasetResponseTransformer, updateDatasetResponseTransformer, getExperimentResponseTransformer, getExperimentsResponseTransformer, runExperimentResponseTransformer, getNotificationsResponseTransformer, updateNotificationsBulkResponseTransformer, updateNotificationResponseTransformer, getQuestionsByStatusResponseTransformer, getPendingQuestionsResponseTransformer, getQuestionResponseTransformer, submitAnswerResponseTransformer, cancelQuestionResponseTransformer, getGroupsResponseTransformer, createGroupResponseTransformer, getGroupResponseTransformer, updateGroupResponseTransformer, removeMemberResponseTransformer, addMemberResponseTransformer } from './transformers.gen';
 ...
 */
export const getQuestionsByStatus = <TComposable extends Composable, DefaultT extends GetQuestionsByStatusResponse = GetQuestionsByStatusResponse>(options: Options<TComposable, GetQuestionsByStatusData, GetQuestionsByStatusResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetQuestionsByStatusResponse | DefaultT, GetQuestionsByStatusError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: getQuestionsByStatusResponseTransformer,
 ...
 */
export const getPendingQuestions = <TComposable extends Composable, DefaultT extends GetPendingQuestionsResponse = GetPendingQuestionsResponse>(options: Options<TComposable, GetPendingQuestionsData, GetPendingQuestionsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetPendingQuestionsResponse | DefaultT, GetPendingQuestionsError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: getPendingQuestionsResponseTransformer,
        url: '/expert/questions/pending',
        ...options
    });
};
 ...
 */
export const getPendingCount = <TComposable extends Composable, DefaultT extends GetPendingCountResponse = GetPendingCountResponse>(options: Options<TComposable, GetPendingCountData, GetPendingCountResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetPendingCountResponse | DefaultT, GetPendingCountError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/expert/questions/pending/count',
        ...options
    });
};
 ...
 */
export const getQuestion = <TComposable extends Composable, DefaultT extends GetQuestionResponse = GetQuestionResponse>(options: Options<TComposable, GetQuestionData, GetQuestionResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetQuestionResponse | DefaultT, GetQuestionError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/expert/questions/{question_id}',
        ...options
    });
};
 ...
 */
export const submitAnswer = <TComposable extends Composable, DefaultT extends SubmitAnswerResponse = SubmitAnswerResponse>(options: Options<TComposable, SubmitAnswerData, SubmitAnswerResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SubmitAnswerResponse | DefaultT, SubmitAnswerError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: submitAnswerResponseTransformer,
        url: '/expert/questions/{question_id}/answer',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
 ...
 */
export const cancelQuestion = <TComposable extends Composable, DefaultT extends CancelQuestionResponse = CancelQuestionResponse>(options: Options<TComposable, CancelQuestionData, CancelQuestionResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, CancelQuestionResponse | DefaultT, CancelQuestionError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: cancelQuestionResponseTransformer,
        url: '/expert/questions/{question_id}/cancel',
        ...options
    });
};
...
/**
 * List Expert Groups
 * Retrieves a list of all available expert groups.
 */
export const getGroups = <TComposable extends Composable, DefaultT extends GetGroupsResponse = GetGroupsResponse>(options: Options<TComposable, GetGroupsData, GetGroupsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetGroupsResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Create Expert Group
 * Creates a new expert group with a name and optional member list.
 */
export const createGroup = <TComposable extends Composable, DefaultT extends CreateGroupResponse = CreateGroupResponse>(options: Options<TComposable, CreateGroupData, CreateGroupResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, CreateGroupResponse | DefaultT, CreateGroupError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Delete Expert Group
 * Permanently deletes an expert group.
 */
export const deleteGroup = <TComposable extends Composable, DefaultT extends DeleteGroupResponse = DeleteGroupResponse>(options: Options<TComposable, DeleteGroupData, DeleteGroupResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).delete<TComposable, DeleteGroupResponse | DefaultT, DeleteGroupError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Get Expert Group
 * Retrieves a single expert group by its unique ID.
 */
export const getGroup = <TComposable extends Composable, DefaultT extends GetGroupResponse = GetGroupResponse>(options: Options<TComposable, GetGroupData, GetGroupResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetGroupResponse | DefaultT, GetGroupError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Update Expert Group
 * Updates an expert group's name, description, or member list.
 */
export const updateGroup = <TComposable extends Composable, DefaultT extends UpdateGroupResponse = UpdateGroupResponse>(options: Options<TComposable, UpdateGroupData, UpdateGroupResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).patch<TComposable, UpdateGroupResponse | DefaultT, UpdateGroupError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 * Removes a user from an expert group.
 */
export const removeMember = <TComposable extends Composable, DefaultT extends RemoveMemberResponse = RemoveMemberResponse>(options: Options<TComposable, RemoveMemberData, RemoveMemberResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).delete<TComposable, RemoveMemberResponse | DefaultT, RemoveMemberError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: removeMemberResponseTransformer,
        url: '/expert/groups/{group_id}/members/{user_id}',
        ...options
    });
};
 ...
 * Adds a user to an expert group.
 */
export const addMember = <TComposable extends Composable, DefaultT extends AddMemberResponse = AddMemberResponse>(options: Options<TComposable, AddMemberData, AddMemberResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, AddMemberResponse | DefaultT, AddMemberError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: addMemberResponseTransformer,
        url: '/expert/groups/{group_id}/members/{user_id}',
        ...options
    });
};
...
/**
 * Send User Message Event To L L M Wrapping Agent Dev Agent
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendUserMessageEventToLLMWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPost = <TComposable extends Composable, DefaultT extends SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostResponse = SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostResponse>(options: Options<TComposable, SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostData, SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostResponse | DefaultT, SendUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Stream User Message Event To L L M Wrapping Agent Dev Agent
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamUserMessageEventToLLMWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventStreamPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, StreamUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventStreamPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, StreamUserMessageEventToLlmWrappingAgentDevAgentAgentsLlmWrappingAgentDevAgentUserMessageEventStreamPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Send Insight Start Event To Insight Agent Insight Agent
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPost = <TComposable extends Composable, DefaultT extends SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostResponse = SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostResponse>(options: Options<TComposable, SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostData, SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostResponse | DefaultT, SendInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/agents/InsightAgent/insight_agent/InsightStartEvent',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
/**
 * Stream Insight Start Event To Insight Agent Insight Agent
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventStreamPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, StreamInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventStreamPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, StreamInsightStartEventToInsightAgentInsightAgentAgentsInsightAgentInsightAgentInsightStartEventStreamPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/agents/InsightAgent/insight_agent/InsightStartEvent/stream',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
/**
 * Send Ask Expert Start Event To Expert Asking Agent Expert Asking Agent
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPost = <TComposable extends Composable, DefaultT extends SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostResponse = SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostResponse>(options: Options<TComposable, SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostData, SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostResponse | DefaultT, SendAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/agents/ExpertAskingAgent/expert_asking_agent/AskExpertStartEvent',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
/**
 * Stream Ask Expert Start Event To Expert Asking Agent Expert Asking Agent
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventStreamPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, StreamAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventStreamPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, StreamAskExpertStartEventToExpertAskingAgentExpertAskingAgentAgentsExpertAskingAgentExpertAskingAgentAskExpertStartEventStreamPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/agents/ExpertAskingAgent/expert_asking_agent/AskExpertStartEvent/stream',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
/**
 * Send Human In The Loop Response Event To R A G Agent Rag Agent
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendHumanInTheLoopResponseEventToRAGAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, SendHumanInTheLoopResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, SendHumanInTheLoopResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/agents/RAGAgent/rag_agent/HumanInTheLoopResponseEvent',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
/**
 * Stream Human In The Loop Response Event To R A G Agent Rag Agent
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamHumanInTheLoopResponseEventToRAGAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventStreamPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, StreamHumanInTheLoopResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventStreamPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, StreamHumanInTheLoopResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopResponseEventStreamPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/agents/RAGAgent/rag_agent/HumanInTheLoopResponseEvent/stream',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
/**
 * Get Form For Human Only Process Human Only Process  Input B
 */
export const getFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGet = <TComposable extends Composable, DefaultT extends GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetResponse = GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetResponse>(options: Options<TComposable, GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetData, GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetResponse | DefaultT, GetFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBGetError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/processes/HumanOnlyProcess/human_only_process/{process_walkthrough_id}/input_b',
        ...options
    });
};

/**
 * Submit Form For Human Only Process Human Only Process  Input B
 */
export const submitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPost = <TComposable extends Composable, DefaultT extends SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostResponse = SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostResponse>(options: Options<TComposable, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostData, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostResponse | DefaultT, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputBProcessesHumanOnlyProcessHumanOnlyProcessProcessWalkthroughIdInputBPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Get Form For Human Only Process Human Only Process  Input A
 */
export const getFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAGet = <TComposable extends Composable, DefaultT extends GetFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAGetResponse = GetFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAGetResponse>(options: Options<TComposable, GetFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAGetData, GetFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAGetResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAGetResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/processes/HumanOnlyProcess/human_only_process/input_a',
        ...options
    });
};

/**
 * Submit Form For Human Only Process Human Only Process  Input A
 */
export const submitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPost = <TComposable extends Composable, DefaultT extends SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostResponse = SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostResponse>(options: Options<TComposable, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostData, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostResponse | DefaultT, SubmitFormForHumanOnlyProcessHumanOnlyProcessInputAProcessesHumanOnlyProcessHumanOnlyProcessInputAPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
