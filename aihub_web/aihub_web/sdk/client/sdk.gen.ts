 ...
 */
export const deleteAgent = <TComposable extends Composable, DefaultT extends DeleteAgentResponse = DeleteAgentResponse>(options: Options<TComposable, DeleteAgentData, DeleteAgentResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).delete<TComposable, DeleteAgentResponse | DefaultT, DeleteAgentError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const createAgent = <TComposable extends Composable, DefaultT extends CreateAgentResponse = CreateAgentResponse>(options: Options<TComposable, CreateAgentData, CreateAgentResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, CreateAgentResponse | DefaultT, CreateAgentError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getAgentClasses = <TComposable extends Composable, DefaultT extends GetAgentClassesResponse = GetAgentClassesResponse>(options: Options<TComposable, GetAgentClassesData, GetAgentClassesResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetAgentClassesResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
