...
import type { GetHealthData, GetHealthResponse, GetSuiteData, GetSuiteResponse, GetSuiteError, GetMyUserData, GetMyUserResponse, GetMyUserError, GetMyDashboardData, GetMyDashboardResponse, GetMyDashboardError, UpdateMyDashboardData, UpdateMyDashboardResponse, UpdateMyDashboardError, GetLocaleData, GetLocaleResponse, GetLocaleError, GetEventsInThreadData, GetEventsInThreadResponse, GetEventsInThreadError, GetEventTimeseriesData, GetEventTimeseriesResponse, GetEventTimeseriesError, GetUserThreadsData, GetUserThreadsResponse, GetUserThreadsError, CreateThreadData, CreateThreadResponse, CreateThreadError, GetThreadData, GetThreadResponse, GetThreadError, AddAgentToThreadData, AddAgentToThreadResponse, AddAgentToThreadError, RemoveAgentFromThreadData, RemoveAgentFromThreadResponse, RemoveAgentFromThreadError, AddUserToThreadData, AddUserToThreadResponse, AddUserToThreadError, RemoveUserFromThreadData, RemoveUserFromThreadResponse, RemoveUserFromThreadError, GetAgentData, GetAgentResponse, GetAgentError, GetAgentThreadsData, GetAgentThreadsResponse, GetAgentThreadsError, GetAgentsData, GetAgentsResponse, GetAgentsError, DiscoverAgentsData, DiscoverAgentsResponse, DiscoverAgentsError, SendEventToLlmWrappingAgentDevAgentSendEventData, SendEventToLlmWrappingAgentDevAgentSendEventResponse, SendEventToLlmWrappingAgentDevAgentSendEventError, ListTokensEndpointData, ListTokensEndpointResponse, ListTokensEndpointError, CreateTokenEndpointData, CreateTokenEndpointResponse, CreateTokenEndpointError, RevokeTokenEndpointData, RevokeTokenEndpointResponse, RevokeTokenEndpointError, GetModelsWithAssistantsData, GetModelsWithAssistantsResponse, GetModelsWithAssistantsError, GetModelWithAssistantsData, GetModelWithAssistantsResponse, GetModelWithAssistantsError, GetEmbeddingsData, GetEmbeddingsResponse, GetEmbeddingsError, ChatCompletionWithAssistantsData, ChatCompletionWithAssistantsResponse, ChatCompletionWithAssistantsError, GenerateImageData, GenerateImageResponse, GenerateImageError, CreateTranscriptionData, CreateTranscriptionResponse, CreateTranscriptionError, CreateSpeechData, CreateSpeechError, GetDatasetsData, GetDatasetsResponse, GetDatasetsError, CreateDatasetData, CreateDatasetResponse, CreateDatasetError, GetDatasetData, GetDatasetResponse, GetDatasetError, UpdateDatasetData, UpdateDatasetResponse, UpdateDatasetError, GetExperimentData, GetExperimentResponse, GetExperimentError, GetExperimentsData, GetExperimentsResponse, GetExperimentsError, RunExperimentData, RunExperimentResponse, RunExperimentError, GetDatabasesData, GetDatabasesResponse, GetDatabasesError, GetDocumentsForNamespaceData, GetDocumentsForNamespaceResponse, GetDocumentsForNamespaceError, GetDocumentByIdData, GetDocumentByIdResponse, GetDocumentByIdError, GetNodesForDocumentData, GetNodesForDocumentResponse, GetNodesForDocumentError, GetSummaryNodesForDocumentData, GetSummaryNodesForDocumentResponse, GetSummaryNodesForDocumentError, GetFileUrlData, GetFileUrlResponse, GetFileUrlError, GetFileRedirectData, GetFileRedirectError, GetAnonymousFileUrlData, GetAnonymousFileUrlError, GetAnonymousFileRedirectData, GetAnonymousFileRedirectError } from './types.gen';
...
export const getSuite = <TComposable extends Composable, DefaultT extends GetSuiteResponse = GetSuiteResponse>(options: Options<TComposable, GetSuiteData, GetSuiteResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetSuiteResponse | DefaultT, GetSuiteError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getMyUser = <TComposable extends Composable, DefaultT extends GetMyUserResponse = GetMyUserResponse>(options: Options<TComposable, GetMyUserData, GetMyUserResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetMyUserResponse | DefaultT, GetMyUserError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getMyDashboard = <TComposable extends Composable, DefaultT extends GetMyDashboardResponse = GetMyDashboardResponse>(options: Options<TComposable, GetMyDashboardData, GetMyDashboardResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetMyDashboardResponse | DefaultT, GetMyDashboardError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getLocale = <TComposable extends Composable, DefaultT extends GetLocaleResponse = GetLocaleResponse>(options: Options<TComposable, GetLocaleData, GetLocaleResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetLocaleResponse | DefaultT, GetLocaleError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getAgents = <TComposable extends Composable, DefaultT extends GetAgentsResponse = GetAgentsResponse>(options: Options<TComposable, GetAgentsData, GetAgentsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetAgentsResponse | DefaultT, GetAgentsError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const discoverAgents = <TComposable extends Composable, DefaultT extends DiscoverAgentsResponse = DiscoverAgentsResponse>(options: Options<TComposable, DiscoverAgentsData, DiscoverAgentsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, DiscoverAgentsResponse | DefaultT, DiscoverAgentsError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const listTokensEndpoint = <TComposable extends Composable, DefaultT extends ListTokensEndpointResponse = ListTokensEndpointResponse>(options: Options<TComposable, ListTokensEndpointData, ListTokensEndpointResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, ListTokensEndpointResponse | DefaultT, ListTokensEndpointError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getModelsWithAssistants = <TComposable extends Composable, DefaultT extends GetModelsWithAssistantsResponse = GetModelsWithAssistantsResponse>(options: Options<TComposable, GetModelsWithAssistantsData, GetModelsWithAssistantsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetModelsWithAssistantsResponse | DefaultT, GetModelsWithAssistantsError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getDatasets = <TComposable extends Composable, DefaultT extends GetDatasetsResponse = GetDatasetsResponse>(options: Options<TComposable, GetDatasetsData, GetDatasetsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetDatasetsResponse | DefaultT, GetDatasetsError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getExperiments = <TComposable extends Composable, DefaultT extends GetExperimentsResponse = GetExperimentsResponse>(options: Options<TComposable, GetExperimentsData, GetExperimentsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetExperimentsResponse | DefaultT, GetExperimentsError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getDatabases = <TComposable extends Composable, DefaultT extends GetDatabasesResponse = GetDatabasesResponse>(options: Options<TComposable, GetDatabasesData, GetDatabasesResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetDatabasesResponse | DefaultT, GetDatabasesError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
