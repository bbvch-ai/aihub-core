...
import type { GetHealthData, GetHealthResponse, GetSuiteData, GetSuiteResponse, GetMyUserData, GetMyUserResponse, GetLocaleData, GetLocaleResponse, GetEventsData, GetEventsResponse, GetEventsError, GetUserThreadsData, GetUserThreadsResponse, GetUserThreadsError, CreateThreadData, CreateThreadResponse, CreateThreadError, GetThreadData, GetThreadResponse, GetThreadError, AddAgentToThreadData, AddAgentToThreadResponse, AddAgentToThreadError, RemoveAgentFromThreadData, RemoveAgentFromThreadResponse, RemoveAgentFromThreadError, AddUserToThreadData, AddUserToThreadResponse, AddUserToThreadError, RemoveUserFromThreadData, RemoveUserFromThreadResponse, RemoveUserFromThreadError, GetThreadEventTimeseriesData, GetThreadEventTimeseriesResponse, GetThreadEventTimeseriesError, GetAgentData, GetAgentResponse, GetAgentError, GetAgentThreadsData, GetAgentThreadsResponse, GetAgentThreadsError, GetAgentEventTimeseriesData, GetAgentEventTimeseriesResponse, GetAgentEventTimeseriesError, GetAgentsData, GetAgentsResponse, DiscoverAgentsData, DiscoverAgentsResponse, SendEventToLlmWrappingAgentDevAgentSendEventData, SendEventToLlmWrappingAgentDevAgentSendEventResponse, SendEventToLlmWrappingAgentDevAgentSendEventError, SendEventToBotInTheLoopAgentBotInTheLoopAgentSendEventData, SendEventToBotInTheLoopAgentBotInTheLoopAgentSendEventResponse, SendEventToBotInTheLoopAgentBotInTheLoopAgentSendEventError, ListTokensEndpointData, ListTokensEndpointResponse, CreateTokenEndpointData, CreateTokenEndpointResponse, CreateTokenEndpointError, RevokeTokenEndpointData, RevokeTokenEndpointResponse, RevokeTokenEndpointError, GetModelsWithAssistantsData, GetModelsWithAssistantsResponse, GetModelWithAssistantsData, GetModelWithAssistantsResponse, GetModelWithAssistantsError, GetEmbeddingsData, GetEmbeddingsResponse, GetEmbeddingsError, ChatCompletionWithAssistantsData, ChatCompletionWithAssistantsResponse, ChatCompletionWithAssistantsError, GenerateImageData, GenerateImageResponse, GenerateImageError, CreateTranscriptionData, CreateTranscriptionResponse, CreateTranscriptionError, CreateSpeechData, CreateSpeechError } from './types.gen';
import { client as _heyApiClient } from './client.gen';
import { getThreadEventTimeseriesResponseTransformer, getAgentEventTimeseriesResponseTransformer, listTokensEndpointResponseTransformer, createTokenEndpointResponseTransformer } from './transformers.gen';
 ...
 * Raises 403 if the user is not a member of that thread.
 */
export const getThreadEventTimeseries = <TComposable extends Composable, DefaultT extends GetThreadEventTimeseriesResponse = GetThreadEventTimeseriesResponse>(options: Options<TComposable, GetThreadEventTimeseriesData, GetThreadEventTimeseriesResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetThreadEventTimeseriesResponse | DefaultT, GetThreadEventTimeseriesError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: getThreadEventTimeseriesResponseTransformer,
