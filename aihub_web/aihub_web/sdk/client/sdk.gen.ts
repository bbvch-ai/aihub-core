 ...
 */
export const getMyDashboardSettings = <TComposable extends Composable, DefaultT extends GetMyDashboardSettingsResponse = GetMyDashboardSettingsResponse>(options: Options<TComposable, GetMyDashboardSettingsData, GetMyDashboardSettingsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetMyDashboardSettingsResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Update My Dashboard Settings
 * Updates the user's dashboard settings.
 * Accepts a `DashboardDTO` in the request body.
 */
export const updateMyDashboardSettings = <TComposable extends Composable, DefaultT extends UpdateMyDashboardSettingsResponse = UpdateMyDashboardSettingsResponse>(options: Options<TComposable, UpdateMyDashboardSettingsData, UpdateMyDashboardSettingsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).put<TComposable, UpdateMyDashboardSettingsResponse | DefaultT, UpdateMyDashboardSettingsError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
