...
/**
 * Send User Message Event To Few Shot Agent Rag Agent
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventPost = <TComposable extends Composable, DefaultT extends SendUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventPostResponse = SendUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventPostResponse>(options: Options<TComposable, SendUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventPostData, SendUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventPostResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SendUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventPostResponse | DefaultT, SendUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/agents/FewShotAgent/rag_agent/UserMessageEvent',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
...
/**
 * Stream User Message Event To Few Shot Agent Rag Agent
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventStreamPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, StreamUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventStreamPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, StreamUserMessageEventToFewShotAgentRagAgentAgentsFewShotAgentRagAgentUserMessageEventStreamPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        url: '/agents/FewShotAgent/rag_agent/UserMessageEvent/stream',
        ...options,
        headers: {
            'Content-Type': 'application/json',
            ...options.headers
