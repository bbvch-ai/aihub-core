 ...
 */
export const getAgentConfiguration = <TComposable extends Composable, DefaultT extends GetAgentConfigurationResponse = GetAgentConfigurationResponse>(options: Options<TComposable, GetAgentConfigurationData, GetAgentConfigurationResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetAgentConfigurationResponse | DefaultT, GetAgentConfigurationError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const updateAgentConfiguration = <TComposable extends Composable, DefaultT extends UpdateAgentConfigurationResponse = UpdateAgentConfigurationResponse>(options: Options<TComposable, UpdateAgentConfigurationData, UpdateAgentConfigurationResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).put<TComposable, UpdateAgentConfigurationResponse | DefaultT, UpdateAgentConfigurationError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Send Human In The Loop Confirmation Response Event To R A G Agent Rag Dev Agent
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendHumanInTheLoopConfirmationResponseEventToRAGAgentRagDevAgentAgentsRagAgentRagDevAgentHumanInTheLoopConfirmationResponseEventPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, SendHumanInTheLoopConfirmationResponseEventToRagAgentRagDevAgentAgentsRagAgentRagDevAgentHumanInTheLoopConfirmationResponseEventPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, SendHumanInTheLoopConfirmationResponseEventToRagAgentRagDevAgentAgentsRagAgentRagDevAgentHumanInTheLoopConfirmationResponseEventPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Stream Human In The Loop Confirmation Response Event To R A G Agent Rag Dev Agent
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamHumanInTheLoopConfirmationResponseEventToRAGAgentRagDevAgentAgentsRagAgentRagDevAgentHumanInTheLoopConfirmationResponseEventStreamPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, StreamHumanInTheLoopConfirmationResponseEventToRagAgentRagDevAgentAgentsRagAgentRagDevAgentHumanInTheLoopConfirmationResponseEventStreamPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, StreamHumanInTheLoopConfirmationResponseEventToRagAgentRagDevAgentAgentsRagAgentRagDevAgentHumanInTheLoopConfirmationResponseEventStreamPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
