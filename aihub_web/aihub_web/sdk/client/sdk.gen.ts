 ...
 */
export const models = <TComposable extends Composable, DefaultT extends ModelsResponse = ModelsResponse>(options: Options<TComposable, ModelsData, ModelsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, ModelsResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const activity = <TComposable extends Composable, DefaultT extends ActivityResponse = ActivityResponse>(options: Options<TComposable, ActivityData, ActivityResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, ActivityResponse | DefaultT, ActivityError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
