 ...
 */
export const completeDocumentUpload = <TComposable extends Composable, DefaultT extends CompleteDocumentUploadResponse = CompleteDocumentUploadResponse>(options: Options<TComposable, CompleteDocumentUploadData, CompleteDocumentUploadResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, CompleteDocumentUploadResponse | DefaultT, CompleteDocumentUploadError, DefaultT>({
