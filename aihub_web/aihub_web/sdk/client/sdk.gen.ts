 ...
 */
export const markAllDone = <TComposable extends Composable, DefaultT extends MarkAllDoneResponse = MarkAllDoneResponse>(options: Options<TComposable, MarkAllDoneData, MarkAllDoneResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, MarkAllDoneResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const markAllRead = <TComposable extends Composable, DefaultT extends MarkAllReadResponse = MarkAllReadResponse>(options: Options<TComposable, MarkAllReadData, MarkAllReadResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, MarkAllReadResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
