...
/**
 * Send Human In The Loop Confirmation Response Event To R A G Agent Rag Agent
 * Send a specific event type to a specific agent. Returns either a stop event or HITL request event.
 */
export const sendHumanInTheLoopConfirmationResponseEventToRAGAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopConfirmationResponseEventPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, SendHumanInTheLoopConfirmationResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopConfirmationResponseEventPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, SendHumanInTheLoopConfirmationResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopConfirmationResponseEventPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Stream Human In The Loop Confirmation Response Event To R A G Agent Rag Agent
 * Send a specific event type to a specific agent and stream all events as SSE.
 */
export const streamHumanInTheLoopConfirmationResponseEventToRAGAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopConfirmationResponseEventStreamPost = <TComposable extends Composable, DefaultT = undefined>(options: Options<TComposable, StreamHumanInTheLoopConfirmationResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopConfirmationResponseEventStreamPostData, unknown, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, unknown | DefaultT, StreamHumanInTheLoopConfirmationResponseEventToRagAgentRagAgentAgentsRagAgentRagAgentHumanInTheLoopConfirmationResponseEventStreamPostError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
