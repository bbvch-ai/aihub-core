 ...
 */
export const getMyUsage = <TComposable extends Composable, DefaultT extends GetMyUsageResponse = GetMyUsageResponse>(options: Options<TComposable, GetMyUsageData, GetMyUsageResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetMyUsageResponse | DefaultT, GetMyUsageError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: getMyUsageResponseTransformer,
        url: '/users/me/usage',
        ...options
    });
};
