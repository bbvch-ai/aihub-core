...
/**
 * Send Event To R A G Agent Dev Agent Send Event
 * Send an event to a specific agent. Raises 403 if the user lacks access.
 */
export const sendEventToRAGAgentDevAgentSendEvent = <TComposable extends Composable, DefaultT extends SendEventToRagAgentDevAgentSendEventResponse = SendEventToRagAgentDevAgentSendEventResponse>(options: Options<TComposable, SendEventToRagAgentDevAgentSendEventData, SendEventToRagAgentDevAgentSendEventResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, SendEventToRagAgentDevAgentSendEventResponse | DefaultT, SendEventToRagAgentDevAgentSendEventError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
