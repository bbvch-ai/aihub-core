...
/**
 * Get Events In Thread
 * Returns all events in a given thread
 */
export const getEventsInThread = <TComposable extends Composable, DefaultT extends GetEventsInThreadResponse = GetEventsInThreadResponse>(options: Options<TComposable, GetEventsInThreadData, GetEventsInThreadResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetEventsInThreadResponse | DefaultT, GetEventsInThreadError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const deleteRoleEndpoint = <TComposable extends Composable, DefaultT extends DeleteRoleEndpointResponse = DeleteRoleEndpointResponse>(options: Options<TComposable, DeleteRoleEndpointData, DeleteRoleEndpointResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).delete<TComposable, DeleteRoleEndpointResponse | DefaultT, DeleteRoleEndpointError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getRoleEndpoint = <TComposable extends Composable, DefaultT extends GetRoleEndpointResponse = GetRoleEndpointResponse>(options: Options<TComposable, GetRoleEndpointData, GetRoleEndpointResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetRoleEndpointResponse | DefaultT, GetRoleEndpointError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const updateRoleEndpoint = <TComposable extends Composable, DefaultT extends UpdateRoleEndpointResponse = UpdateRoleEndpointResponse>(options: Options<TComposable, UpdateRoleEndpointData, UpdateRoleEndpointResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).patch<TComposable, UpdateRoleEndpointResponse | DefaultT, UpdateRoleEndpointError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const listRolesEndpoint = <TComposable extends Composable, DefaultT extends ListRolesEndpointResponse = ListRolesEndpointResponse>(options: Options<TComposable, ListRolesEndpointData, ListRolesEndpointResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, ListRolesEndpointResponse | DefaultT, unknown, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const createRoleEndpoint = <TComposable extends Composable, DefaultT extends CreateRoleEndpointResponse = CreateRoleEndpointResponse>(options: Options<TComposable, CreateRoleEndpointData, CreateRoleEndpointResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).post<TComposable, CreateRoleEndpointResponse | DefaultT, CreateRoleEndpointError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
