 ...
 * Raises 403 if the user is not a member of that thread.
 */
export const getThreadTimeStatistics = <TComposable extends Composable, DefaultT extends GetThreadTimeStatisticsResponse = GetThreadTimeStatisticsResponse>(options: Options<TComposable, GetThreadTimeStatisticsData, GetThreadTimeStatisticsResponse, DefaultT>) => {
    return (options.client ?? _heyApiClient).get<TComposable, GetThreadTimeStatisticsResponse | DefaultT, GetThreadTimeStatisticsError, DefaultT>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
        ...
        responseTransformer: getThreadTimeStatisticsResponseTransformer,
