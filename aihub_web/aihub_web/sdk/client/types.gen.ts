...
export type UserMessageEventReadable = {
     ...
     */
    readonly _parent_event_names: Array<string>;
    [key: string]: unknown | string | number | LocaleString | UserIdentity | Array<ChatMessageOutput | UserChatMessageOutput | AssistantChatMessageOutput> | (Array<UserUploadedFile> | null) | Array<string> | undefined;
};
...
export type UserMessageEventWritable = {
     ...
     */
    files?: Array<UserUploadedFile> | null;
    [key: string]: unknown | string | number | LocaleString | UserIdentity | Array<ChatMessageOutput | UserChatMessageOutput | AssistantChatMessageOutput> | (Array<UserUploadedFile> | null) | undefined;
};
...
export type SendEventToRagAgentDevAgentSendEventData = {
    ...
    url: '/agents/r_a_g_agent/dev_agent/send_event';
};

export type SendEventToRagAgentDevAgentSendEventErrors = {
    /**
     * Validation Error
     */
    422: HttpValidationError;
...
export type SendEventToRagAgentDevAgentSendEventError = SendEventToRagAgentDevAgentSendEventErrors[keyof SendEventToRagAgentDevAgentSendEventErrors];

export type SendEventToRagAgentDevAgentSendEventResponses = {
    /**
     * Successful Response
     */
...
export type SendEventToRagAgentDevAgentSendEventResponse = SendEventToRagAgentDevAgentSendEventResponses[keyof SendEventToRagAgentDevAgentSendEventResponses];
