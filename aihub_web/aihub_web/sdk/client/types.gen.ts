...
export type ChatCompletionRequest = {
  ...
  [key: string]:
    ...
    | boolean
    | (string | null)
    | (ChatCompletionAudioParam | null)
    | (number | null)
    | (("none" | "auto") | ChatCompletionFunctionCallOptionParam | null)
    | (Array<OpenaiTypesChatCompletionCreateParamsFunction> | null)
    | ({
        [key: string]: number;
      } | null)
    | (boolean | null)
    ...
    | (number | null)
    | (boolean | null)
    | (ChatCompletionPredictionContentParam | null)
    | (number | null)
    ...
    | (boolean | null)
    | (ChatCompletionStreamOptionsParam | null)
    | (number | null)
    | (
        | ("none" | "auto" | "required")
        | ChatCompletionNamedToolChoiceParam
    ...
    | (Array<ChatCompletionToolParam> | null)
    | (number | null)
    | (number | null)
    | undefined;
};
...
export type ImageGenerationRequest = {
  ...
  [key: string]:
    ...
    | (("standard" | "hd") | null)
    | (("url" | "b64_json") | null)
    | (("256x256" | "512x512" | "1024x1024" | "1792x1024" | "1024x1792") | null)
    | (("vivid" | "natural") | null)
    | undefined;
};
...
export type UserMessageEvent = {
   ...
   */
  messages?: Array<
    ChatMessageOutput | UserChatMessageOutput | AssistantChatMessageOutput
  >;
  /**
   * The event type name, usually the class name. If unknown, uses _unknown_type.
   * Used during deserialization to decide which subclass to instantiate.
...
export type UserMessageEventInput = {
   ...
   */
  messages?: Array<
    ChatMessageInput | UserChatMessageInput | AssistantChatMessageInput
  >;
};
...
export type SendEventToLlmWrappingAgentDevAgentSendEventError =
  SendEventToLlmWrappingAgentDevAgentSendEventErrors[keyof SendEventToLlmWrappingAgentDevAgentSendEventErrors];
...
export type SendEventToLlmWrappingAgentDevAgentSendEventResponse =
  SendEventToLlmWrappingAgentDevAgentSendEventResponses[keyof SendEventToLlmWrappingAgentDevAgentSendEventResponses];
