...
AI-Hub provides a Python setup script that automates this process:
:::
...
::: info
AI-Hub bots maintain conversation state across user interactions and bot restarts through the `ConversationEntity`
system:
:::
