...
async def main():
    ...
    async with process_runner.test_run(delay_before_stop=25):
        async with runner_b.test_run(delay_before_stop=20):
            async with runner_a.test_run(delay_before_stop=10) as topic:
