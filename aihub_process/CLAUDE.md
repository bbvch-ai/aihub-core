# aihub_process - Agentic Process SDK

**Purpose**: SDK for orchestrating multi-entity business processes. Two parts: the framework (`aihub_process/`), and
...
**Note**: No `app/` directory yet (WIP). Will follow the same entry-point pattern as `aihub_agent` once processes are
production-ready.

## Folder Structure

```
aihub_process/                         # SDK framework
├── agentic_processes/
...
`ProcessConfig` inherits from `Form` — same duality pattern as `AgentConfig`. See `aihub_agent/CLAUDE.md` for the full
Form Duality, FormKit Elements, and Form Constraints documentation (identical system).
...
- ProcessConfig: `aihub_lib/processes/ProcessConfig.py`
- Form base: `aihub_lib/nats/events/form/Form.py`
- ProcessConfigSpecs: `aihub_lib/nats/events/discovery/process/ProcessConfigSpecs.py`
- ProcessConfigClient (RPC): `aihub_lib/nats/rpc/ProcessConfigClient.py`
- ProcessConfigEntityDocument: `aihub_lib/persistence/process/ProcessConfigEntityDocument.py`
- WorkEvent: `aihub_lib/nats/events/work/WorkEvent.py`
- WorkRequestEvent: `aihub_lib/nats/events/work_request/WorkRequestEvent.py`
- AgentWorkEvent: `aihub_lib/nats/events/work/agent/AgentWorkEvent.py`
- HumanWorkEvent: `aihub_lib/nats/events/work/human/HumanWorkEvent.py`
- Topics: `aihub_lib/nats/topics/process/`
- Topic managers: `aihub_lib/nats/topic_managers/process/`

**From aihub_api** (config responder):

- ProcessConfigResponder: `aihub_api/rpc/ProcessConfigResponder.py`
