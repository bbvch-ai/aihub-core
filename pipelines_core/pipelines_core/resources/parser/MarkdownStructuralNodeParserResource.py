...
from lib_core.generative_ai.document.parsers.MarkdownStructuralNodeParser import MarkdownStructuralNodeParser
...
class MarkdownStructuralNodeParserResource(ConfigurableResource):
    ...
    .. code-block:: python
        from pipelines_core.resources.app.MarkdownStructuralNodeParserResource import MarkdownStructuralNodeParserResource
