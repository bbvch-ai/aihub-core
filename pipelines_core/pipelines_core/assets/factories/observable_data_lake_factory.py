...
from pipelines_core.pipelines_core.ops.data_lake.data_version_by_partition_for_data_lake_files import (
    data_version_by_partition_for_data_lake_files_no_op,
)
from pipelines_core.pipelines_core.ops.data_lake.fetch_all_files_in_data_lake import fetch_all_files_in_data_lake_no_op
