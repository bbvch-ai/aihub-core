...
At the lowest level is **`aihub_lib`**, the foundational shared library for code used by more than one service. Building on this, we provide a base layer for the core AI components:
...
* **`scope`**: Describes what part of the codebase is affected, such as a package name, customer, or initiative (e.g., `aihub`, `api`, `bbv`).
