...
[![License](https://img.shields.io/badge/license-Apache%202.0%20%2F%20AGPL%20%2F%20BUSL-blue?style=flat-square)](LICENSES.md)
...
- **BUSL-1.1** — multi-tenant administration (`packages/sysadmin-api`, `packages/sysadmin-web`): non-production use only
  until the Change Date, after which it converts to Apache-2.0.
