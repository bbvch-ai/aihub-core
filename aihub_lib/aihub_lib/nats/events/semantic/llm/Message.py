...
class Message(BaseModel):
    ...
    name: Annotated[Optional[str], Field(description="The name of the function or agent generating the message.")] = (
        None
    )
    ...
    function_call_name: Annotated[
        Optional[str], Field(description="The name of the function being called in the message.")
    ] = None
    ...
    tool_call_id: Annotated[Optional[str], Field(description="The ID of the tool call, if applicable.")] = None
    contents: Annotated[
