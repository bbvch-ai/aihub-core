...
class Checkbox(PrimeVueElement):
    ...
    true_value: Annotated[Any, Field(description="Value to emit when checked", alias="trueValue")] = True
    false_value: Annotated[Any, Field(description="Value to emit when unchecked", alias="falseValue")] = False
    ...
    def in_locale(self, t: LocaleHandler) -> "Checkbox":
