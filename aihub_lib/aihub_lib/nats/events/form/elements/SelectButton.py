...
class SelectButton(PrimeVueElement):
    ...
    formkit: Annotated[Literal["primeSelectButton"], Field(description="PrimeVue SelectButton element.")] = "primeSelectButton"
    ...
    option_disabled: Annotated[str | None, Field(description="Property name to use as the disabled flag of an option", alias="optionDisabled")] = None
    ...
    data_key: Annotated[str | None, Field(description="Property name for unique option identification", alias="dataKey")] = None
