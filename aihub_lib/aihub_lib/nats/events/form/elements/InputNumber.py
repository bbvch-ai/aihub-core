...
class InputNumber(PrimeVueElement):
    ...
    formkit: Annotated[Literal["primeInputNumber"], Field(description="PrimeVue InputNumber element.")] = "primeInputNumber"
    ...
    min_fraction_digits: Annotated[int | None, Field(description="Minimum number of fraction digits", alias="minFractionDigits")] = None
    max_fraction_digits: Annotated[int | None, Field(description="Maximum number of fraction digits", alias="maxFractionDigits")] = None
    ...
    show_buttons: Annotated[bool, Field(description="Whether to show increment/decrement buttons", alias="showButtons")] = False
    button_layout: Annotated[Literal["stacked", "horizontal"] | None, Field(description="Layout of increment/decrement buttons", alias="buttonLayout")] = None
