...
class RadioButton(PrimeVueElement):
    ...
    formkit: Annotated[Literal["primeRadioButton"], Field(description="PrimeVue RadioButton element.")] = "primeRadioButton"
    ...
    option_class: Annotated[str | None, Field(description="CSS class to apply to each option", alias="optionClass")] = None
