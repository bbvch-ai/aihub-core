...
class Rating(PrimeVueElement):
    ...
    on_icon: Annotated[str | None, Field(description="Icon for selected state", alias="onIcon", pattern=r"^pi pi-[a-z0-9-]+$")] = None
    off_icon: Annotated[str | None, Field(description="Icon for unselected state", alias="offIcon", pattern=r"^pi pi-[a-z0-9-]+$")] = None
    cancel_icon: Annotated[str | None, Field(description="Icon for cancel button", alias="cancelIcon", pattern=r"^pi pi-[a-z0-9-]+$")] = None
