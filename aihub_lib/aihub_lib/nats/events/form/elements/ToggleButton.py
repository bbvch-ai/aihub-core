...
class ToggleButton(PrimeVueElement):
    ...
    formkit: Annotated[Literal["primeToggleButton"], Field(description="PrimeVue ToggleButton element.")] = "primeToggleButton"
    ...
    off_label: Annotated[LocaleString | str | None, Field(description="Label for the off state", alias="offLabel")] = None
    on_icon: Annotated[str | None, Field(description="Icon for the on state", alias="onIcon", pattern=r"^pi pi-[a-z0-9-]+$")] = None
    off_icon: Annotated[str | None, Field(description="Icon for the off state", alias="offIcon", pattern=r"^pi pi-[a-z0-9-]+$")] = None
    icon_pos: Annotated[Literal["left", "right"] | None, Field(description="Position of the icon", alias="iconPos")] = None
