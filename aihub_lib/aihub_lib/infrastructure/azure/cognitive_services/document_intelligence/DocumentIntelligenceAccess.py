...
class DocumentIntelligenceAccess(CognitiveServiceAccess):
    ...
    def _initialize(self):
        ...
        self._resource_group_name = (
            AzureDocumentIntelligenceSettings().RESOURCE_GROUP_NAME or f"{self._app}-rg-{self._region}"
        )
        self._di_service_name = AzureDocumentIntelligenceSettings().RESOURCE_NAME or f"{self._app}-di-{self._region}"
