...
class NodeData(BaseModel):
    ...
    input_events: Annotated[Optional[Dict[str, InputEventInfo]], Field(description="Input events required by this node")] = None
    output_events: Annotated[Optional[List[EventInfo]], Field(description="Output events produced by this node")] = None
    max_executions: Annotated[Optional[int], Field(description="Maximum number of times this node can be executed")] = None
    stop_on_error: Annotated[Optional[bool], Field(description="Whether workflow should stop on error in this node")] = None
