...
async def main():
    ...
    runner = AgentRunner(
        ...
        default_agent_config=KnowledgeRetrievalAgentConfig(
            ...
            agent_id="shared_knowledge_retrieval_dev_agent",
            name=LocaleString(
                en="Shared Knowledge Retrieval Dev Agent",
                de="Geteiltes Wissensabruf Dev Agent",
                fr="Agent de recuperation de connaissances partagees Dev",
                it="Agente di recupero conoscenze condivise Dev",
            ),
