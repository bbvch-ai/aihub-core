...
from aihub_agent.agents.ExpertAskingAgent.ExpertAskingAgentConfig import ExpertAskingAgentConfig, Expert
...
async def main():
    runner = AgentTestRunner(
        ...
        agent_config=ExpertAskingAgentConfig(
            ...
            experts=[
                Expert(name="Joel Barmettler", email="joel.barmettler@bbv.ch", expertise="Artificial Intelligence")
            ],
