...
from playground.minimal_workflow.bounded_iterative_loop.events.BeginEvent import BeginEvent
from playground.minimal_workflow.bounded_iterative_loop.events.DecisionEvent import DecisionEvent
from playground.minimal_workflow.bounded_iterative_loop.events.ProcessAEvent import ProcessAEvent


class BoundedIterativeLoopAgent(Agent):
    @step()
    ...
    @step()
    async def decision_step(self, event: ProcessAEvent, agent_config: BoundedIterativeLoopAgentConfig, run_context: RunContext) -> DecisionEvent | BeginEvent:
