...
from aihub_lib.nats.events import LLMStopEvent, UserMessageEvent, LimitChatHistoryEvent
...
class LLMWrappingAgent(Agent):
    ...
    @step(
        name=AgentLocaleString.from_i18n_path("agent.steps.llm_wrapping.start.name"),
        description=AgentLocaleString.from_i18n_path("agent.steps.llm_wrapping.start.description"),
        icon="mage:message",
    )
