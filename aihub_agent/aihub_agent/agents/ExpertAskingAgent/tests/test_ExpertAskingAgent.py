...
from aihub_lib.nats.events.bot_in_the_loop.request.BotInTheLoopRequestEvent import (
    BotInTheLoopRequestEvent,
    TeamsConfig,
)
from aihub_lib.nats.events.bot_in_the_loop.response.BotInTheLoopResponseEvent import (
...
from aihub_agent.agents.ExpertAskingAgent.ExpertAskingAgentConfig import ChannelConfig, ExpertAskingAgentConfig
from aihub_agent.runners.AgentTestRunner import AgentTestRunner

enable_logging()

# Mark all tests in this module as azure (skipped in CI - requires Azure OpenAI for function calling)
