import inspect
import logging
from typing import Annotated, Callable, Optional, Awaitable
...
def step(
    *,
    ...
    precondition: Annotated[Optional[Callable[..., Awaitable[bool]]], "A function to check if the step is ready to run"] = None,
):
    """
