...
### The `@step` Decorator: Building Blocks of Workflows
...
### Step 1: Create the Agent, Configuration, and Events

Follow this three-part process to define a new agent.
...
#### Primary Observability Tool: Phoenix Tracing (Port 6006)
...
All agent code must use strict Python type annotations.
...
#### Complex, Validated Configuration
